...
var h,
  ...
  X = l({}),
  j = l(function () {}),
  Y = "undefined" == typeof HTMLElement ? "undefined" : l(HTMLElement),
  q = function (e) {
    return e && e.instanceString && U(e.instanceString)
      ? e.instanceString()
      : null;
  },
  W = function (e) {
  ...
  K = function (e) {
    return null != e && l(e) === X && !H(e) && e.constructor === Object;
  },
  G = function (e) {
    return null != e && l(e) === l(1) && !isNaN(e);
  },
  Z = function (e) {
  ...
  Q = function (e) {
    return "collection" === q(e) && e._private.single;
  },
  J = function (e) {
    return "collection" === q(e) && !e._private.single;
  },
  ...
  le = function (e) {
    return ne(e) ? e : e.charAt(0).toUpperCase() + e.substring(1);
  },
  ue = function (e, t) {
  ...
  be = function (e) {
    for (var t = e.map, n = e.keys, r = n.length, a = 0; a < r; a++) {
      var i = n[a];
      if (K(i)) throw Error("Tried to set map with object key");
      a < n.length - 1
        ? (null == t[i] && (t[i] = {}), (t = t[i]))
        : (t[i] = e.value);
    }
  ...
  xe = function (e) {
    for (var t = e.map, n = e.keys, r = n.length, a = 0; a < r; a++) {
      var i = n[a];
      if (K(i)) throw Error("Tried to get map with object key");
...
function Te() {
  ...
  var e = (function () {
      if (g) return p;
      g = 1;
      var e = "object" == typeof we && we && we.Object === Object && we;
      return (p = e);
    })(),
...
var De = Ee(
    (function () {
      ...
      return (O = function (i, o, s) {
        ...
        function b(e) {
          var t = e - f;
          return void 0 === f || t >= o || t < 0 || (v && e - p >= c);
        }
        function x() {
          var e = t();
          if (b(e)) return w(e);
        ...
        function E() {
          ...
          if (((l = arguments), (u = this), (f = e), n)) {
            if (void 0 === h)
              return (function (e) {
                return ((p = e), (h = setTimeout(x, o)), g ? m(e) : d);
              })(f);
            if (v) return (clearTimeout(h), (h = setTimeout(x, o)), m(f));
          }
  ...
  Me = (function () {
    if (c) {
      ...
      if (c.mozRequestAnimationFrame)
        return function (e) {
          c.mozRequestAnimationFrame(e);
        };
      if (c.webkitRequestAnimationFrame)
        return function (e) {
          c.webkitRequestAnimationFrame(e);
        };
      if (c.msRequestAnimationFrame)
        return function (e) {
          c.msRequestAnimationFrame(e);
        };
    }
    return function (e) {
      e &&
...
var He = !0,
  Ke = null != console.warn,
  Ge = null != console.trace,
  ...
  rt = function (e) {
    nt() && (Ke ? console.warn(e) : (console.log(e), Ge && console.trace()));
  },
  at = function (e) {
    return null == e
      ? e
  ...
  gt =
    "undefined" !== ("undefined" == typeof Set ? "undefined" : l(Set))
      ? Set
      : pt,
  vt = function (e, t) {
    var n = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2];
    if (void 0 !== e && void 0 !== t && ee(e)) {
      var r = t.group;
      if (
        (null == r &&
          (r =
    ...
    } else tt("An element must have a core reference and parameters set");
  },
  yt = function (e) {
    return (
      ...
      function (t, n, r) {
        ...
        (K(t) &&
          !$(t) &&
          ((t = (a = t).roots || a.root), (n = a.visit), (r = a.directed)),
          (r = 2 !== arguments.length || U(n) ? r : n),
          (n = U(n) ? n : function () {}));
        for (
          var i,
            o = this._private.cy,
  ...
  mt = {
    breadthFirstSearch: yt({ bfs: !0 }),
    depthFirstSearch: yt({ dfs: !0 }),
  };
((mt.bfs = mt.breadthFirstSearch), (mt.dfs = mt.depthFirstSearch));
var bt,
  xt,
  wt,
  Et = { exports: {} },
...
function Tt() {
  return (
    bt ||
      ...
      (e = Et),
      function () {
        var t, n, r, a, i, o, s, l, u, c, d, h, f, p, g;
        ((r = Math.floor),
          (c = Math.min),
          (n = function (e, t) {
            return e < t ? -1 : e > t ? 1 : 0;
          ...
          (o = function (e, t, r) {
            return (null == r && (r = n), e.push(t), p(e, 0, e.length - 1, r));
          }),
          (i = function (e, t) {
            var r, a;
            return (
              null == t && (t = n),
              (r = e.pop()),
              e.length ? ((a = e[0]), (e[0] = r), g(e, 0, t)) : (a = r),
              a
            );
          }),
          (l = function (e, t, r) {
          ...
          (a = function (e, t) {
            ...
            for (
              ...
              ((a = s[i]), l.push(g(e, a, t)));
            return l;
          }),
          (f = function (e, t, r) {
            var a;
            if ((null == r && (r = n), -1 !== (a = e.indexOf(t))))
              return (p(e, 0, a, r), g(e, a, r));
          }),
          (d = function (e, t, r) {
            var i, o, l, u, c;
...
var Ct,
        ...
        if (((d[k] = E), E !== 1 / 0))
          for (
            ...
            var P = T[C],
              ...
              B = x(w, P),
              D = E + B.dist;
            D < g(P) && (v(P, D), (c[S] = { node: w, edge: B.edge }));
          }
      }
      return {
        distanceTo: function (e) {
          var t = W(e) ? f.filter(e)[0] : e[0];
          return d[t.id()];
        },
        pathTo: function (e) {
          var t = W(e) ? f.filter(e)[0] : e[0],
    ...
    kruskal: function (e) {
      ...
      for (
        ...
        var d = u[c],
          ...
          v = i[p],
          y = i[g];
        p !== g && (o.merge(d), v.merge(y), i.splice(g, 1));
      }
      return o;
    },
  },
  ...
  At = {
    aStar: function (e) {
      ...
      for (var x, w = 0; g.size() > 0;) {
        ...
        p[u] = !0;
        for (var P = l._private.edges, S = 0; S < P.length; S++) {
          var B = P[S];
          if (this.hasElementWithId(B.id()) && (!o || B.data("source") === u)) {
            var D = B.source(),
              _ = B.target(),
              A = D.id() !== u ? D : _,
              M = A.id();
  ...
  Rt = {
    floydWarshall: function (e) {
      ...
      for (var y = new Array(c), m = new Array(c), b = 0; b < l.length; b++) {
        var x = l[b],
          w = x.source()[0],
          E = x.target()[0];
        if (w !== E) {
      ...
      if (E)
        for (var M = [], R = 0; R < v; R++) {
          ...
          if (O + z < V || (!a && V + z < O)) {
            if (
              (p ||
                (rt("Graph contains a negative weight cycle for Bellman-Ford"),
                (p = !0)),
            ...
            for (var X = F.length, j = 0; j < X; j++) {
              var Y = F[j],
                q = [Y];
              q.push(y(Y).edge);
              for (var U = y(Y).pred; -1 === q.indexOf(U);)
                (q.push(U), q.push(y(U).edge), (U = y(U).pred));
              for (
                var H = (q = q.slice(q.indexOf(U)))[0].id(), K = 0, G = 2;
                G < q.length;
                G += 2
              )
                q[G].id() < H && ((H = q[G].id()), (K = G));
              ...
              var Z = q
                ...
                .join(",");
              -1 === M.indexOf(Z) && (g.push(s.spawn(q)), M.push(Z));
            }
          }
        }
      return {
  ...
  Lt = Math.sqrt(2),
  zt = function (e, t, n) {
    0 === n.length && tt("Karger-Stein must be run on a connected (sub)graph");
    for (
      var r = n[e],
        a = r[1],
        i = r[2],
    ...
    kargerStein: function () {
      ...
      if (!(a < 2)) {
        ...
        for (
          ...
          var b = Ot(p, l.slice(), a, s),
            x = b.slice();
          v(p, g);
          var w = Ot(p, b, s, 2),
            E = Ot(g, x, s, 2);
          w.length <= E.length && w.length < d
            ? ((d = w.length), (h = w), v(p, f))
            : E.length <= w.length &&
              E.length < d &&
              ((d = E.length), (h = E), v(g, f));
        }
        for (
          var k = this.spawn(
              h.map(function (e) {
  ...
  tn = function (e) {
    ...
    if (1 === o.length) t = n = r = a = o[0];
    else if (2 === o.length) ((t = r = o[0]), (a = n = o[1]));
    else if (4 === o.length) {
      var s = i(o, 4);
  ...
  sn = function (e, t) {
    return an(e, t.x1, t.y1) && an(e, t.x2, t.y2);
  },
  ln =
    null !== (Ct = Math.hypot) && void 0 !== Ct
      ? Ct
      : function (e, t) {
...
function un(e, t, n, r, a, i) {
  var o = (function (e, t) {
      ...
      for (var l, u, c = s.length, d = [], h = 0; h < c; h++) {
        var f = s[h],
          p = s[(h + 1) % c],
          g = r(p, f),
          v =
      ...
      for (
        var y = d.map(function (e, r) {
            return { p1: n(s[r], a(e, t)), p2: n(s[(r + 1) % c], a(e, t)) };
          }),
          m = [],
          b = 0;
        b < c;
...
var cn = function (e, t, n, r, a, i, o) {
    var s,
      l,
      u =
        arguments.length > 7 && void 0 !== arguments[7] ? arguments[7] : "auto",
      c = "auto" === u ? Dn(a, i) : u,
      d = a / 2,
      h = i / 2,
    ...
    if (f) {
      var g = r - h - o;
      if (
        (s = En(e, t, n, r, n - d + c - o, g, n + d - c + o, g, !1)).length > 0
      )
        return s;
    }
    if (p) {
      var v = n + d + o;
      if (
        (s = En(e, t, n, r, v, r - h + c - o, v, r + h - c + o, !1)).length > 0
      )
        return s;
    }
    if (f) {
      var y = r + h + o;
      if (
        (s = En(e, t, n, r, n - d + c - o, y, n + d - c + o, y, !1)).length > 0
      )
        return s;
    }
    if (p) {
      var m = n - d - o;
      if (
        (s = En(e, t, n, r, m, r - h + c - o, m, r + h - c + o, !1)).length > 0
      )
        return s;
    }
    var b = n - d + c,
      x = r - h + c;
    if ((l = xn(e, t, n, r, b, x, c + o)).length > 0 && l[0] <= b && l[1] <= x)
      return [l[0], l[1]];
    var w = n + d - c,
      E = r - h + c;
    if ((l = xn(e, t, n, r, w, E, c + o)).length > 0 && l[0] >= w && l[1] <= E)
      return [l[0], l[1]];
    var k = n + d - c,
      T = r + h - c;
    if ((l = xn(e, t, n, r, k, T, c + o)).length > 0 && l[0] >= k && l[1] >= T)
      return [l[0], l[1]];
    var C = n - d + c,
      P = r + h - c;
    return (l = xn(e, t, n, r, C, P, c + o)).length > 0 &&
      l[0] <= C &&
      l[1] >= P
      ? [l[0], l[1]]
      : [];
  },
  dn = function (e, t, n, r, a, i, o) {
    var s = o,
      l = Math.min(n, a),
      u = Math.max(n, a),
      c = Math.min(r, i),
  ...
  fn = function (e, t, n, r, a, i, o, s) {
    ...
    (u.push(1), u.push(0));
    for (var d, h, f, p = -1, g = 0; g < u.length; g++)
      ((d =
        Math.pow(1 - u[g], 2) * n +
        2 * (1 - u[g]) * u[g] * a +
        u[g] * u[g] * o),
  ...
  Tn = function (e, t, n, r, a, i, o, s) {
    ...
    if ((null == i && (v = !1), v)) {
      for (var y = 0; y < g.length / 2; y++)
        ((g[2 * y] = n[2 * y] * i + r), (g[2 * y + 1] = n[2 * y + 1] * o + a));
      if (s > 0) {
        var m = mn(g, -s);
        u = yn(m);
      } else u = g;
    ...
    for (var b = 0; b < u.length / 2; b++)
      ((c = u[2 * b]),
        ...
        b < u.length / 2 - 1
          ...
          : ((h = u[0]), (f = u[1])),
        0 !== (l = En(e, t, r, a, c, d, h, f)).length && p.push(l[0], l[1]));
    return p;
  },
  Cn = function (e, t, n) {
  ...
  Sn = function (e) {
    ...
    for (var u = 2 / (o - a), c = 2 / (s - i), d = 0; d < r; d++)
      ((t = e[2 * d] = e[2 * d] * u),
        ...
        (s = Math.max(s, n)));
    if (i < -1)
      for (var h = 0; h < r; h++) n = e[2 * h + 1] = e[2 * h + 1] + (-1 - i);
    return e;
  },
  Bn = function (e, t) {
    var n = (1 / e) * 2 * Math.PI,
...
function Mn(e, t) {
  ...
  var s,
    l = r([].concat(o(n(e)), o(n(t))));
  try {
    for (l.s(); !(s = l.n()).done;) {
      var u = s.value;
      if (!i(a(e, u), a(t, u))) return !1;
    }
  } catch (e) {
    l.e(e);
  } finally {
  ...
  Ln = {
    degreeCentralityNormalized: function (e) {
      ...
      if (e.directed) {
        ...
        return {
          indegree: function (e) {
            return 0 == o ? 0 : (W(e) && (e = t.filter(e)), a[e.id()] / o);
          },
          outdegree: function (e) {
            return 0 === s ? 0 : (W(e) && (e = t.filter(e)), i[e.id()] / s);
          },
        };
      }
      ...
      return {
        degree: function (e) {
          return 0 === f ? 0 : (W(e) && (e = t.filter(e)), h[e.id()] / f);
        },
      };
    },
    degreeCentrality: function (e) {
      ...
      for (
        var y = a.connectedEdges().intersection(n), m = y.length, b = 0, x = 0;
        x < y.length;
        x++
      )
        b += i(y[x]);
    ...
    closenessCentralityNormalized: function (e) {
      ...
      return {
        closeness: function (e) {
          return 0 == s
            ? 0
            : ((e = W(e) ? i.filter(e)[0].id() : e.id()), o[e] / s);
        },
      };
    },
...
((On.cc = On.closenessCentrality),
  (On.ccn = On.closenessCentralityNormalised =
    On.closenessCentralityNormalized));
var Vn = lt({ weight: null, directed: !1 }),
  Fn = {
      ...
      for (
        var g = function () {
            ...
            for (l[e] = 1, u[e] = 0, h.push(e); !h.empty();) {
              var g = h.pop();
              if ((t.push(g), a))
                for (var y = 0; y < s[g].length; y++) {
                  var m = s[g][y],
                    b = i.getElementById(g),
                    x = void 0;
                  x =
                    b.edgesTo(m).length > 0 ? b.edgesTo(m)[0] : m.edgesTo(b)[0];
                  var w = r(x);
                  ((m = m.id()),
                    u[m] > u[g] + w &&
                      ((u[m] = u[g] + w),
                      h.nodes.indexOf(m) < 0 ? h.push(m) : h.updateItem(m),
                      (l[m] = 0),
                      (n[m] = [])),
                    u[m] == u[g] + w && ((l[m] = l[m] + l[g]), n[m].push(g)));
                }
              else
                for (var E = 0; E < s[g].length; E++) {
                  var k = s[g][E].id();
                  (u[k] == 1 / 0 && (h.push(k), (u[k] = u[g] + 1)),
                    u[k] == u[g] + 1 && ((l[k] = l[k] + l[g]), n[k].push(g)));
                }
            }
...
Fn.bc = Fn.betweennessCentrality;
var Xn = lt({
    expandFactor: 2,
    inflateFactor: 2,
    multFactor: 1,
  ...
  qn = function (e, t, n) {
    for (var r = new Array(n * n), a = 0; a < n; a++) {
      ...
      for (var o = 0; o < n; o++)
        for (var s = 0; s < n; s++) r[a * n + s] += e[a * n + o] * t[o * n + s];
    }
    return r;
  },
  Wn = function (e, t, n) {
    for (var r = e.slice(0), a = 1; a < n; a++) e = qn(e, r, t);
    return e;
  },
  Un = function (e, t, n) {
  ...
  Gn = function (e) {
    ...
    for (var y = !0, m = 0; y && m < a.maxIterations;)
      ((y = !1),
        (s = Wn(c, l, a.expandFactor)),
        (c = Un(s, l, a.inflateFactor)),
        Hn(c, s, u, 4) || (y = !0),
        m++);
    ...
    return (
      (b = (function (e) {
        for (var t = 0; t < e.length; t++)
          for (var n = 0; n < e.length; n++)
            t != n && Kn(e[t], e[n]) && e.splice(n, 1);
        return e;
      })(b)),
      b
    );
  },
  Zn = { markovClustering: Gn, mcl: Gn },
  $n = function (e) {
    return e;
  },
  Qn = function (e, t) {
  ...
  nr = function (e, t, n) {
    return Math.max(e, Qn(t, n));
  },
  rr = function (e, t, n, r, a) {
    for (
      var i =
          arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : $n,
        o = r,
        s = 0;
      s < e;
      s++
  ...
  ar = {
    euclidean: function (e, t, n) {
      return e >= 2 ? rr(e, t, n, 0, er, tr) : rr(e, t, n, 0, Jn);
    },
    squaredEuclidean: function (e, t, n) {
      return rr(e, t, n, 0, er);
    },
    manhattan: function (e, t, n) {
      return rr(e, t, n, 0, Jn);
    },
    max: function (e, t, n) {
      return rr(e, t, n, -1 / 0, nr);
    },
  };
function ir(e, t, n, r, a, i) {
  var o;
  return (
    (o = U(e) ? e : ar[e] || ar.euclidean),
    0 === t && U(e) ? o(a, i) : o(t, n, r, a, i)
  );
}
((ar["squared-euclidean"] = ar.squaredEuclidean),
  (ar.squaredeuclidean = ar.squaredEuclidean));
var or = lt({
    k: 2,
    m: 2,
  ...
  gr = function (e, t) {
    ...
    if (e.length < 50)
      for (var r = 0; r < t; r++) {
        for (var a = e[Math.floor(Math.random() * e.length)]; pr(a, n, r);)
  ...
  vr = function (e, t, n) {
    for (var r = 0, a = 0; a < t.length; a++)
      r += lr("manhattan", t[a], e, n, "kMedoids");
    return r;
  },
  ...
  mr = function (e, t, n, r, a) {
    for (var i = 0; i < e.length; i++) t[i] = e[i].slice();
    for (var o, s, l, u = 2 / (a.m - 1), c = 0; c < n.length; c++)
      for (var d = 0; d < r.length; d++) {
        o = 0;
        for (var h = 0; h < n.length; h++)
          ((s = lr(a.distance, r[d], n[c], a.attributes, "cmeans")),
            (l = lr(a.distance, r[d], n[h], a.attributes, "cmeans")),
            (o += Math.pow(s / l, u)));
        e[d][c] = 1 / o;
      }
  },
  br = function (e) {
    ...
    for (var v = 0; v < s.length; v++) i[v] = new Array(l.k);
    for (var y = !0, m = 0; y && m < l.maxIterations;)
      ((y = !1),
        yr(n, s, r, i, l),
        mr(r, a, n, s, l),
        fr(r, a, l.sensitivityThreshold) || (y = !0),
        m++);
    return (
      (t = (function (e, t, n, r) {
        for (var a, i, o = new Array(n.k), s = 0; s < o.length; s++) o[s] = [];
    ...
    kMeans: function (e) {
      ...
      i.testMode
        ? "number" == typeof i.testCentroids
          ? (i.testCentroids, (t = ur(r, i.k, i.attributes)))
          : (t =
              "object" === l(i.testCentroids)
                ? i.testCentroids
                : ur(r, i.k, i.attributes))
        : (t = ur(r, i.k, i.attributes));
      for (var u = !0, c = 0; u && c < i.maxIterations;) {
        for (var d = 0; d < r.length; d++)
          s[(a = r[d]).id()] = cr(a, t, i.distance, i.attributes, "kMeans");
        u = !1;
        for (var h = 0; h < i.k; h++) {
          var f = dr(h, r, s);
          if (0 !== f.length) {
            for (
              ...
              ((v[m] = y[m] / f.length),
                hr(v[m], g[m], i.sensitivityThreshold) || (u = !0));
            }
    ...
    kMedoids: function (e) {
      ...
      o.testMode
        ? "number" == typeof o.testCentroids ||
          (t = "object" === l(o.testCentroids) ? o.testCentroids : gr(a, o.k))
        : (t = gr(a, o.k));
      for (var d = !0, h = 0; d && h < o.maxIterations;) {
        for (var f = 0; f < a.length; f++)
          u[(i = a[f]).id()] = cr(i, t, o.distance, o.attributes, "kMedoids");
        d = !1;
        for (var p = 0; p < t.length; p++) {
          var g = dr(p, a, u);
          if (0 !== g.length) {
            c[p] = vr(t[p], g, o.attributes);
            for (var v = 0; v < g.length; v++)
              (n = vr(g[v], g, o.attributes)) < c[p] &&
                ((c[p] = n), (t[p] = g[v]), (d = !0));
            s[p] = r.collection(g);
          }
        }
  ...
  kr = function (e, t, n, r, a) {
    ...
    for (var v = 0; v < e.length; v++) {
      ...
      (p.key === y.key
        ...
        : "min" === a.linkage
          ? ((i = n[p.key][y.key]),
            n[p.key][y.key] > n[g.key][y.key] && (i = n[g.key][y.key]))
          : "max" === a.linkage
            ? ((i = n[p.key][y.key]),
              n[p.key][y.key] < n[g.key][y.key] && (i = n[g.key][y.key]))
            : (i =
                "mean" === a.linkage
                  ? (n[p.key][y.key] * p.size + n[g.key][y.key] * g.size) /
                    (p.size + g.size)
                  : "dendrogram" === a.mode
                    ? u(y.value, p.value)
  ...
  Tr = function (e, t, n) {
    e &&
      (e.value
        ? t.push(e.value)
        : (e.left && Tr(e.left, t), e.right && Tr(e.right, t)));
  },
  Cr = function (e, t) {
    if (!e) return "";
    if (e.left && e.right) {
  ...
  Pr = function (e, t, n) {
    ...
    return 0 === t
      ...
      : 1 === t
        ...
        : e.value
          ? [n.collection(e.value)]
          : (e.left && (r = Pr(e.left, t - 1, n)),
            e.right && (a = Pr(e.right, t - 1, n)),
            r.concat(a));
  },
  Sr = function (e) {
    for (
    ...
    for (var g, v = kr(o, u, s, l, r); v;) v = kr(o, u, s, l, r);
    return (
      "dendrogram" === r.mode
        ? ((g = Pr(o[0], r.dendrogramDepth, t)), r.addDendrogram && Cr(o[0], t))
  ...
  Br = { hierarchicalClustering: Sr, hca: Sr },
  Dr = lt({
    distance: "euclidean",
    preference: "median",
    damping: 0.8,
        ...
        "median" === t
          ? (function (e) {
              ...
              for (var i = 0, o = e.length - 1; o >= 0; o--) {
                var s = e[o];
                a ? isFinite(s) || ((e[o] = -1 / 0), i++) : e.splice(o, 1);
              }
              r &&
                e.sort(function (e, t) {
                  return e - t;
              ...
              var l = e.length,
                u = Math.floor(l / 2);
              return l % 2 != 0 ? e[u + 1 + i] : (e[u - 1 + i] + e[u + i]) / 2;
            })(e)
          : "mean" === t
            ? (function (e) {
                for (
  ...
  Rr = function (e) {
      ...
      var t,
        ...
        u = (function (e) {
          var t = e.damping,
            n = e.preference;
          (0.5 <= t && t < 1) ||
            tt("Damping must range on [0.5, 1).  Got: ".concat(t));
    ...
    for (var f = 0; f < t; f++)
      for (var p = 0; p < t; p++)
        f !== p && (r[f * t + p] = _r(u.distance, l[f], l[p], u.attributes));
    a = Ar(r, u.preference);
    ...
    for (
      ...
      ((m[w] = 0), (b[w] = 0), (x[w] = 0));
    for (var E, k = new Array(t * u.minIterations), T = 0; T < k.length; T++)
      k[T] = 0;
    for (E = 0; E < u.maxIterations; E++) {
      for (var C = 0; C < t; C++) {
        ...
        i[C * t + B] = (1 - u.damping) * (r[C * t + B] - S) + u.damping * m[B];
      }
      for (var M = 0; M < t; M++) {
      ...
      if (L > 0 && (E >= u.minIterations - 1 || E == u.maxIterations - 1)) {
    ...
    for (
      var j = (function (e, t, n) {
        ...
        Y = (function (e, t, n) {
          for (var r = Mr(e, t, n), a = 0; a < n.length; a++) {
    ...
    for (var K = new Array(j.length), Z = 0; Z < j.length; Z++)
      K[Z] = s.collection(q[j[Z]]);
    return K;
  },
  Ir = { affinityPropagation: Rr, ap: Rr },
  Nr = lt({ root: void 0, directed: !1 }),
  Lr = function () {
    var e = this,
      t = {},
      n = 0,
                            ...
                            s.forEach(function (n) {
                              ...
                              (l.merge(n),
                                r.forEach(function (n) {
                                  var r = n.id(),
                                    a = n.connectedEdges().intersection(e);
                                  (l.merge(n),
                                    t[r].cutVertex
                                      ? l.merge(
                                          a.filter(function (e) {
  ...
  Ir,
  {
    hierholzer: function (e) {
      ...
      var n,
        ...
        l = this,
        u = !1;
      o && (a = W(o) ? this.filter(o)[0].id() : o[0].id());
      var c = {},
        d = {};
      s
      ...
      var f = function (e) {
        ...
        p = [],
        g = [];
      for (g = f(a); 1 != g.length;)
        0 == c[g[0]].length
          ? (p.unshift(l.getElementById(g.shift())),
            p.unshift(l.getElementById(g.shift())))
          : (g = f(g.shift()).concat(g));
      for (var v in (p.unshift(l.getElementById(g.shift())), c))
        if (c[v].length) return h;
      return ((h.found = !0), (h.trail = this.spawn(p, !0)), h);
    },
  },
  {
    hopcroftTarjanBiconnected: Lr,
    htbc: Lr,
    htb: Lr,
    hopcroftTarjanBiconnectedComponents: Lr,
  },
  {
    tarjanStronglyConnected: zr,
    tsc: zr,
    tscc: zr,
    tarjanStronglyConnectedComponents: zr,
  },
].forEach(function (e) {
  ve(Or, e);
});
...
Vr.prototype = {
  fulfill: function (e) {
    return Fr(this, 1, "fulfillValue", e);
  },
  reject: function (e) {
    return Fr(this, 2, "rejectReason", e);
  },
  then: function (e, t) {
    var n = this,
      r = new Vr();
    return (
      n.onFulfilled.push(Yr(e, r, "fulfill")),
      n.onRejected.push(Yr(t, r, "reject")),
      Xr(n),
      r.proxy
    );
  },
...
var Fr = function (e, t, n, r) {
    return (0 === e.state && ((e.state = t), (e[n] = r), Xr(e)), e);
  },
  Xr = function (e) {
    1 === e.state
      ? jr(e, "onFulfilled", e.fulfillValue)
      : 2 === e.state && jr(e, "onRejected", e.rejectReason);
  },
  jr = function (e, t, n) {
    if (0 !== e[t].length) {
      var r = e[t];
      ...
      "function" == typeof setImmediate ? setImmediate(a) : setTimeout(a, 0);
    }
  },
  Yr = function (e, t, n) {
    return function (r) {
  ...
  qr = function (e, t) {
    if (e !== t && e.proxy !== t) {
      var n;
      if (("object" === l(t) && null !== t) || "function" == typeof t)
        try {
          n = t.then;
        } catch (t) {
...
((Vr.all = function (e) {
  ...
  (Vr.resolve = function (e) {
    return new Vr(function (t, n) {
      t(e);
    });
  }),
  (Vr.reject = function (e) {
    return new Vr(function (t, n) {
      n(e);
    });
  }));
var Wr = "undefined" != typeof Promise ? Promise : Vr,
  Ur = function (e, t, n) {
    var r = ee(e),
      a = !r,
      i = (this._private = ve({ duration: 1e3 }, t, n));
    if (
      ((i.target = e),
      ...
      (i.completes = []),
      (i.frames = []),
      i.complete && U(i.complete) && i.completes.push(i.complete),
      a)
    ) {
      var o = e.position();
      ((i.startPosition = i.startPosition || { x: o.x, y: o.y }),
        (i.startStyle =
          i.startStyle || e.cy().style().getAnimationStartStyle(e, i.style)));
    }
    if (r) {
      var s = e.pan();
...
(ve(Hr, {
  ...
  hook: function () {
    ...
    if (!e.hooked) {
      ...
      ((e.queue ? t.queue : t.current).push(this),
        $(e.target) && e.target.cy().addToAnimationPool(e.target),
        (e.hooked = !0));
    }
    return this;
  },
  ...
  (Hr.complete = Hr.completed),
  (Hr.run = Hr.play),
  (Hr.running = Hr.playing));
var Kr,
  Gr,
  Zr,
  $r,
  ...
  Pi = {
    ...
    animation: function () {
      return function (e, t) {
        ...
        var l = i.style();
        if (((e = ve({}, e, t)), 0 === Object.keys(e).length))
          return new Ur(a[0], e);
        ...
        if (
          (s &&
            ((e.style = l.getPropsList(e.style || e.css)), (e.css = void 0)),
        ...
        if (o && null != p) {
          var g = i.getCenterPan(p.eles, e.zoom);
          null != g && (e.pan = g);
        }
        if (o && null != e.fit) {
          var v = e.fit,
    ...
    t = (function () {
      ...
      return (
        (Ma = function (n) {
          ...
          return !(
            a < 0 ||
            (a == r.length - 1 ? r.pop() : t.call(r, a, 1), --this.size, 0)
          );
        }),
        Ma
      );
...
function oo() {
  ...
  var e = (function () {
      ...
      return (
        (Gi = function (r, a, i) {
          var o = r[a];
          (n.call(r, a) && t(o, i) && (void 0 !== i || a in r)) || e(r, a, i);
        }),
        Gi
      );
    })(),
...
var po = (function () {
        ...
        function (t, n) {
          ...
          if (W(t)) {
            ...
            for (var b = 0; b < m.length; b++) {
              if (((v = y[(g = m[b])]), !r.immutableKeys[g]))
                for (var x = 0; x < s.length; x++) {
                  var w = s[x];
                  r.canSet(w) && (w._private[r.field][g] = v);
                }
            }
            (r.updateStyle && i.updateStyle(),
              r.onSet(i),
              r.settingTriggersEvent && i[r.triggerFnName](r.settingEvent));
          } else if (r.allowBinding && U(t)) {
            var E = t;
            i.on(r.bindingEvent, E);
    ...
    removeData: function (e) {
      return (
        ...
        function (t) {
          ...
          if (W(t)) {
            for (var i = t.split(/\s+/), o = i.length, s = 0; s < o; s++) {
              var l = i[s];
              if (!ne(l))
            ...
            for (var d = 0, h = a.length; d < h; d++)
              for (
                var f = a[d]._private[n.field], p = Object.keys(f), g = 0;
                g < p.length;
                g++
              ) {
                var v = p[g];
                !n.immutableKeys[v] && (f[v] = void 0);
              }
            n.triggerEvent && r[n.triggerFnName](n.event);
          }
          return r;
  ...
  mo = {};
[Pi, vo, yo].forEach(function (e) {
  ve(mo, e);
});
var bo = {
    animate: mo.animate(),
    animation: mo.animation(),
    animated: mo.animated(),
    clearQueue: mo.clearQueue(),
    delay: mo.delay(),
    delayAnimation: mo.delayAnimation(),
    stop: mo.stop(),
  },
  xo = {
    classes: function (e) {
      ...
      H(e) || (e = (e || "").match(/\S+/g) || []);
      for (var r = [], a = new gt(e), i = 0; i < t.length; i++) {
        for (
        ...
        (u || (u = l.size !== e.length), u && ((s.classes = a), r.push(o)));
      }
...
xo.className = xo.classNames = xo.classes;
var wo = {
  metaChar:
    "[\\!\\\"\\#\\$\\%\\&\\'\\(\\)\\*\\+\\,\\.\\/\\:\\;\\<\\=\\>\\?\\@\\[\\]\\^\\`\\{\\|\\}\\~]",
  comparatorOp: "=|\\!=|>|>=|<|<=|\\$=|\\^=|\\*=",
...
((wo.variable = "(?:[\\w-.]|(?:\\\\" + wo.metaChar + "))+"),
  (wo.className = "(?:[\\w-]|(?:\\\\" + wo.metaChar + "))+"),
  (wo.value = wo.string + "|" + wo.number),
  (wo.id = wo.variable),
  (function () {
    var e, t, n;
    for (e = wo.comparatorOp.split("|"), n = 0; n < e.length; n++)
      ((t = e[n]), (wo.comparatorOp += "|@" + t));
    for (e = wo.comparatorOp.split("|"), n = 0; n < e.length; n++)
      (t = e[n]).indexOf("!") >= 0 ||
        ("=" !== t && (wo.comparatorOp += "|\\!" + t));
  })());
var Eo = 0,
  ...
  qo = (function () {
    for (var e, t = {}, n = 0; n < Yo.length; n++)
      t[(e = Yo[n]).selector] = e.matches;
    return t;
  })(),
  Wo =
    "(" +
  ...
  Ko = [
    {
      ...
      populate: function (e, t, n) {
        var r = i(n, 1)[0];
        t.checks.push({ type: Eo, value: "*" === r ? r : r + "s" });
      },
    },
    {
      name: "state",
    ...
    },
    {
      ...
      populate: function (e, t, n) {
        var r = i(n, 1)[0];
        t.checks.push({ type: _o, value: Uo(r) });
      },
    },
    {
      name: "className",
      ...
      populate: function (e, t, n) {
        var r = i(n, 1)[0];
        t.checks.push({ type: Ao, value: Uo(r) });
      },
    },
    {
      name: "dataExists",
      query: !0,
      regex: "\\[\\s*(" + wo.variable + ")\\s*\\]",
      populate: function (e, t, n) {
        var r = i(n, 1)[0];
        t.checks.push({ type: Po, field: Uo(r) });
      },
    },
    {
      name: "dataCompare",
      ...
      populate: function (e, t, n) {
        var r = i(n, 3),
          ...
          s = r[2];
        ((s =
          null != new RegExp("^" + wo.string + "$").exec(s)
            ? s.substring(1, s.length - 1)
            : parseFloat(s)),
          t.checks.push({ type: Co, field: Uo(a), operator: o, value: s }));
      },
    },
    {
      name: "dataBool",
      query: !0,
      regex: "\\[\\s*(" + wo.boolOp + ")\\s*(" + wo.variable + ")\\s*\\]",
      populate: function (e, t, n) {
        var r = i(n, 2),
          a = r[0],
          o = r[1];
        t.checks.push({ type: So, field: Uo(o), operator: a });
      },
    },
    {
      name: "metaCompare",
      ...
      populate: function (e, t) {
        if (null == e.currentSubject) {
          var n = { checks: [] },
            ...
            a = { checks: [] };
          return (
            n.checks.push({ type: Ro, source: r, target: a }),
            Ho(e, 0, n),
            e.edgeCount++,
            a
          );
        ...
        var i = { checks: [] },
          ...
          s = { checks: [] };
        return (
          i.checks.push({ type: Io, source: o, target: s }),
          Ho(e, 0, i),
          e.edgeCount++,
          s
        );
      ...
      populate: function (e, t) {
        if (null == e.currentSubject) {
          var n = { checks: [] },
            ...
            a = { checks: [] };
          return (
            n.checks.push({ type: Mo, nodes: [r, a] }),
            Ho(e, 0, n),
            e.edgeCount++,
            a
          );
        ...
        var i = { checks: [] },
          ...
          s = { checks: [] };
        return (
          i.checks.push({ type: Lo, node: o, neighbor: s }),
          Ho(e, 0, i),
          s
        );
      },
      ...
      populate: function (e, t) {
        if (null == e.currentSubject) {
          var n = { checks: [] },
            ...
            a = e[e.length - 1];
          return (
            n.checks.push({ type: zo, parent: a, child: r }),
            Ho(e, 0, n),
            e.compoundCount++,
            r
          );
        ...
        if (e.currentSubject === t) {
          var i = { checks: [] },
            ...
            c = { checks: [] };
          return (
            i.checks.push({ type: Xo, left: o, right: s, subject: l }),
            (l.checks = t.checks),
            (t.checks = [{ type: jo }]),
            c.checks.push({ type: jo }),
            s.checks.push({ type: Vo, parent: c, child: u }),
            Ho(e, 0, i),
            (e.currentSubject = l),
            e.compoundCount++,
            u
      ...
      populate: function (e, t) {
        if (null == e.currentSubject) {
          var n = { checks: [] },
            ...
            a = e[e.length - 1];
          return (
            n.checks.push({ type: Oo, ancestor: a, descendant: r }),
            Ho(e, 0, n),
            e.compoundCount++,
            r
          );
        ...
        if (e.currentSubject === t) {
          ...
          return (
            ...
            (t.checks = [{ type: jo }]),
            c.checks.push({ type: jo }),
            s.checks.push({ type: Fo, ancestor: c, descendant: u }),
            Ho(e, 0, i),
            (e.currentSubject = l),
            e.compoundCount++,
            u
        ...
        var d = { checks: [] },
          h = { checks: [] },
          f = [{ type: Fo, ancestor: d, descendant: h }];
        return ((d.checks = t.checks), (t.checks = f), e.compoundCount++, h);
      },
    },
    {
      ...
      populate: function (e, t) {
        if (null != e.currentSubject && e.currentSubject !== t)
          return (
            rt("Redefinition of subject in selector `" + e.toString() + "`"),
            !1
          );
        e.currentSubject = t;
...
var Go = function (e) {
    for (var t, n, r, a = 0; a < Ko.length; a++) {
      var i = Ko[a],
        o = i.name,
  ...
  Zo = {
    parse: function (e) {
      ...
      for (
        ...
        var a = Go(n);
        if (null == a.expr)
          return (rt("The selector `" + e + "`is invalid"), !1);
        var i = a.match.slice(1),
          o = a.expr.populate(t, r, i);
        if (!1 === o) return !1;
        if ((null != o && (r = o), (n = a.remaining).match(/^\s*$/))) break;
      }
      var s = t[t.length - 1];
...
((Jo[Eo] = function (e, t) {
  ...
  (Jo[Po] = function (e, t) {
    var n = e.field;
    return (e.operator, void 0 !== Qo(t, n));
  }),
  (Jo[Mo] = function (e, t) {
    var n = e.nodes[0],
      r = e.nodes[1],
      a = t.source(),
      i = t.target();
    return (es(n, a) && es(r, i)) || (es(r, a) && es(n, i));
  }),
  (Jo[Lo] = function (e, t) {
    return (
      es(e.node, t) &&
      t.neighborhood().some(function (t) {
        return t.isNode() && es(e.neighbor, t);
      })
    );
  }),
  (Jo[Ro] = function (e, t) {
    return es(e.source, t.source()) && es(e.target, t.target());
  }),
  (Jo[Io] = function (e, t) {
    return (
      es(e.source, t) &&
      t.outgoers().some(function (t) {
        return t.isNode() && es(e.target, t);
      })
    );
  }),
  (Jo[No] = function (e, t) {
    return (
      ...
      t.incomers().some(function (t) {
        return t.isNode() && es(e.source, t);
      })
    );
  }),
  (Jo[zo] = function (e, t) {
    return es(e.child, t) && es(e.parent, t.parent());
  }),
  (Jo[Vo] = function (e, t) {
    return (
      es(e.parent, t) &&
  ...
  (Jo[Fo] = function (e, t) {
    return (
      ...
      t.descendants().some(function (t) {
        return es(e.descendant, t);
      })
    );
  }),
  (Jo[Xo] = function (e, t) {
    return es(e.subject, t) && es(e.left, t) && es(e.right, t);
  }),
  (Jo[jo] = function () {
    return !0;
  }),
  ...
  ns = function (e) {
    ((this.inputText = e),
      ...
      null == e ||
        (W(e) && e.match(/^\s*$/)) ||
        ($(e)
          ? this.addQuery({ checks: [{ type: ko, value: e.collection() }] })
          : U(e)
            ? this.addQuery({ checks: [{ type: To, value: e }] })
            : W(e)
              ? this.parse(e) || (this.invalid = !0)
              : tt("A selector must be created from a string; found ")));
  },
  rs = ns.prototype;
([Zo, ts].forEach(function (e) {
  return ve(rs, e);
}),
  (rs.text = function () {
  ...
  (rs.sameText = function (e) {
    return !this.invalid && !e.invalid && this.text() === e.text();
  }),
  (rs.addQuery = function (e) {
    this[this.length++] = e;
  }),
  (rs.selector = rs.toString));
var as = {
  allAre: function (e) {
    var t = new ns(e);
...
((as.allAreNeighbours = as.allAreNeighbors),
  (as.has = as.contains),
  (as.equal = as.equals = as.same));
var is,
  os,
  ss = function (e, t) {
...
function us(e, t, n, r) {
  for (
    var a = [], i = new gt(), o = e.cy().hasCompoundNodes(), s = 0;
    s < e.length;
    s++
  ) {
    var l = e[s];
...
((ls.forEachDown = function (e) {
  ...
  (ls.forEachUpAndDown = function (e) {
    return us(
      this,
      e,
      !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1],
  ...
  ((is = os =
    {
      ...
      removeRscratch: mo.removeData({ field: "rscratch", triggerEvent: !1 }),
      id: function () {
        var e = this[0];
        if (e) return e._private.data.id;
      },
    }).attr = is.data),
  (is.removeAttr = is.removeData));
var fs,
  ps,
  gs = os,
  vs = {};
function ys(e) {
  return function (t) {
    var n = this;
    if (
      (void 0 === t && (t = !0), 0 !== n.length && n.isNode() && !n.removed())
    ) {
      for (
...
(ve(vs, {
  degree: ys(function (e, t) {
    return t.source().same(t.target()) ? 2 : 1;
  }),
  indegree: ys(function (e, t) {
    return t.target().same(e) ? 1 : 0;
  }),
  outdegree: ys(function (e, t) {
    return t.source().same(e) ? 1 : 0;
  }),
}),
  ve(vs, {
    minDegree: ms("degree", function (e, t) {
      return e < t;
    }),
    maxDegree: ms("degree", function (e, t) {
      return e > t;
    }),
    minIndegree: ms("indegree", function (e, t) {
      return e < t;
    }),
    maxIndegree: ms("indegree", function (e, t) {
      return e > t;
    }),
    minOutdegree: ms("outdegree", function (e, t) {
      return e < t;
    }),
    maxOutdegree: ms("outdegree", function (e, t) {
      return e > t;
    }),
  }),
  ve(vs, {
...
var bs = function (e, t, n) {
    for (var r = 0; r < e.length; r++) {
      ...
      if (!a.locked()) {
        ...
        (!a.isParent() || (0 === o.x && 0 === o.y) || a.children().shift(o, n),
...
((fs = ps =
  {
    ...
    positions: function (e, t) {
      if (K(e)) t ? this.silentPosition(e) : this.position(e);
      else if (U(e)) {
        var n = e,
          r = this.cy();
        r.startBatch();
    ...
    shift: function (e, t, n) {
      ...
      if (
        (K(e)
          ? ((r = { x: G(e.x) ? e.x : 0, y: G(e.y) ? e.y : 0 }), (n = t))
          : W(e) && G(t) && ((r = { x: 0, y: 0 })[e] = t),
        null != r)
      ) {
        var a = this.cy();
        a.startBatch();
    ...
    silentShift: function (e, t) {
      return (
        K(e) ? this.shift(e, !0) : W(e) && G(t) && this.shift(e, t, !0),
        this
      );
    },
    renderedPosition: function (e, t) {
      ...
      if (n && n.isNode()) {
        if (!s) {
          var l = n.position();
          return ((o = Ft(l, a, i)), void 0 === e ? o : o[e]);
        }
        for (var u = 0; u < this.length; u++) {
          var c = this[u];
          void 0 !== t
            ? c.position(e, (t - i[e]) / a)
            : void 0 !== o && c.position(Xt(o, a, i));
        }
      } else if (!s) return;
      return this;
    },
  ...
  (fs.modelPosition = fs.point = fs.position),
  (fs.modelPositions = fs.points = fs.positions),
  (fs.renderedPoint = fs.renderedPosition),
  (fs.relativePoint = fs.relativePosition));
var ws,
  Es,
  ks = ps,
  Ts = function (e) {
...
((ws = Es = {}),
  (Es.renderedBoundingBox = function (e) {
  ...
  (Es.dirtyCompoundBoundsCache = function () {
  ...
  (Es.updateCompoundBounds = function () {
    var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
      t = this.cy();
...
var Ps = function (e) {
  ...
  Bs = function (e, t) {
    return null == t ? e : Ss(e, t.x1, t.y1, t.x2, t.y2);
  },
  Ds = function (e, t, n) {
    return dt(e, t, n);
  },
  ...
  As = function (e, t, n) {
    if (!t.cy().headless()) {
      ...
      if (t.pstyle(r + "label").strValue) {
        ...
        var S = v - Math.max(x, w) - E - 2,
          B = v + Math.max(x, w) + E + 2,
        ...
        if (I || N) {
          var L = I ? Ds(a.rstyle, "labelAngle", n) : b.pfValue,
            z = Math.cos(L),
            O = Math.sin(L),
            V = (o + s) / 2,
            F = (l + u) / 2;
  ...
  Ms = function (e, t) {
    if (!t.cy().headless()) {
      ...
      Rs(e, t, n, r, "outside", r / 2);
    }
  },
  Rs = function (e, t, n, r, a, i) {
    if (!(0 === n || r <= 0 || "inside" === a)) {
      var o = t.cy().renderer(),
      ...
      if (s) {
        ...
        if (s.hasMiterBounds) {
          "center" === a && (r /= 2);
          var f = s.miterBounds(u, c, d, h, r);
          Bs(e, f);
        } else null != i && i > 0 && tn(e, [i, i, i, i]);
      }
    }
  },
  Is = function (e, t) {
    ...
    if (b) {
      ...
      var E = Math.max(x, w),
        k = 0;
      if ((c && (k = e.pstyle("width").pfValue / 2), p && t.includeNodes)) {
        var T = e.position();
        ((o = T.x), (s = T.y));
        var C = e.outerWidth() / 2,
          P = e.outerHeight() / 2;
        (Ss(h, (n = o - C), (a = s - P), (r = o + C), (i = s + P)),
          c && Ms(h, e),
          c && t.includeOutlines && !d && Ms(h, e),
          c &&
            (function (e, t) {
              if (!t.cy().headless()) {
      ...
      if (
        ...
        if ("yes" === e.pstyle("ghost").value) {
          ...
          Ss(h, h.x1 + O, h.y1 + V, h.x2 + O, h.y2 + V);
        }
      ...
      (nn(F, h),
        ...
        c &&
          ...
          (a = h.y1),
          (i = h.y2),
          Ss(h, n - E, a - E, r + E, i + E)));
      var X = (f.overlayBounds = f.overlayBounds || {});
      (nn(X, h), tn(X, y), en(X, 1));
      ...
      (null != j.all
        ...
        c &&
          t.includeLabels &&
          (t.includeMainLabels && As(h, e, null),
          g &&
            (t.includeSourceLabels && As(h, e, "source"),
            t.includeTargetLabels && As(h, e, "target"))));
    }
    return (
      (h.x1 = Ps(h.x1)),
      (h.y1 = Ps(h.y1)),
  ...
  Ls = function (e) {
    ...
    if (e.isEdge()) {
      var n = e.source().position(),
        r = e.target().position();
      return je([t(n.x), t(n.y), t(r.x), t(r.y)]);
    }
    var a = e.position();
    return je([t(a.x), t(a.y)]);
  },
  zs = function (e, t) {
    var n,
      r = e._private,
    ...
    if (
      (null == r.bbCache
        ? ((n = Is(e, Os)), (r.bbCache = n), (r.bbCachePosKey = Ls(e)))
        : (n = r.bbCache),
      !i)
    ) {
      var o = e.isNode();
      ((n = Qt()),
        ((t.includeNodes && o) || (t.includeEdges && !o)) &&
          (t.includeOverlays ? Bs(n, r.overlayBounds) : Bs(n, r.bodyBounds)),
        t.includeLabels &&
          (t.includeMainLabels &&
          (!a || (t.includeSourceLabels && t.includeTargetLabels))
            ? Bs(n, r.labelBounds.all)
            : (t.includeMainLabels && Bs(n, r.labelBounds.mainRot),
              t.includeSourceLabels && Bs(n, r.labelBounds.sourceRot),
              t.includeTargetLabels && Bs(n, r.labelBounds.targetRot))),
        (n.w = n.x2 - n.x1),
        (n.h = n.y2 - n.y1));
    }
    return n;
  ...
  Vs = Ns(Os),
  Fs = lt(Os);
((Es.boundingBox = function (e) {
  var t,
    n = void 0 === e || void 0 === e.useCache || !0 === e.useCache,
    r = ae(
      function (e) {
        var t = e._private;
        return null == t.bbCache || t.styleDirty || t.bbCachePosKey !== Ls(e);
      },
      function (e) {
        return e.id();
      },
  ...
  if (n && 1 === this.length && !r(this[0]))
    ((e = void 0 === e ? Os : Fs(e)), (t = zs(this[0], e)));
  else {
    t = Qt();
    var a = Fs((e = e || Os)),
      i = this,
    ...
    for (var s = 0; s < i.length; s++) {
      var l = i[s];
      (r(l) && l.dirtyBoundingBoxCache(), Bs(t, zs(l, a)));
    }
  }
  return (
    (t.x1 = Ps(t.x1)),
  ...
  (Es.dirtyBoundingBoxCache = function () {
  ...
  (ws.boundingbox = ws.bb = ws.boundingBox),
  (ws.renderedBoundingbox = ws.renderedBoundingBox));
var Xs,
  js,
  Ys = Es;
Xs = js = {};
var qs = function (e) {
  ((e.uppercaseName = le(e.name)),
    (e.autoName = "auto" + e.uppercaseName),
    (e.labelName = "label" + e.uppercaseName),
    (e.outerName = "outer" + e.uppercaseName),
    (e.uppercaseOuterName = le(e.outerName)),
    (Xs[e.name] = function () {
      var t = this[0],
        n = t._private,
    ...
    (Xs["outer" + e.uppercaseName] = function () {
      var t = this[0],
    ...
    (Xs["rendered" + e.uppercaseName] = function () {
      var t = this[0];
      if (t) return t[e.name]() * this.cy().zoom();
    }),
    (Xs["rendered" + e.uppercaseOuterName] = function () {
      var t = this[0];
...
var Ws = js,
  ...
  Hs = Object.keys(Us).reduce(function (e, t) {
    var n = Us[t],
      r = (function (e) {
...
Gs.prototype = {
  ...
  recycle: function (e, t) {
    if (
      ...
      null != e && e.preventDefault
        ? ((this.type = e.type),
          (this.isDefaultPrevented = e.defaultPrevented ? $s : Zs))
        : null != e && e.type
          ? (t = e)
          : (this.type = e),
      null != t &&
  ...
  isDefaultPrevented: Zs,
  isPropagationStopped: Zs,
  isImmediatePropagationStopped: Zs,
};
var Qs = /^([^.]+)(\.(?:[^.]+))?$/,
  Js = {
...
var rl = nl.prototype,
  al = function (e, t, n, r, a, i, o) {
    (U(r) && ((a = r), (r = null)), o && (i = null == i ? o : ve({}, i, o)));
    for (var s = H(n) ? n : n.split(/\s+/), l = 0; l < s.length; l++) {
      var u = s[l];
      if (!ne(u)) {
        var c = u.match(Qs);
        if (c) if (!1 === t(e, u, c[1], c[2] ? c[2] : null, r, a, i)) break;
      }
    }
  },
  il = function (e, t) {
    return (e.addEventFields(e.context, t), new Gs(t.type, t));
  },
  ol = function (e, t, n) {
    if ("event" !== q(n))
      if (K(n)) t(e, il(e, n));
      else
        for (var r = H(n) ? n : n.split(/\s+/), a = 0; a < r.length; a++) {
          var i = r[a];
          if (!ne(i)) {
            var o = i.match(Qs);
            if (o) {
              var s = o[1],
                l = o[2] ? o[2] : null;
              t(e, il(e, { type: s, namespace: l, target: e.context }));
            }
          }
        }
    else t(e, n);
  };
((rl.on = rl.addListener =
  function (e, t, n, r, a) {
    return (
      al(
        this,
  ...
  (rl.one = function (e, t, n, r) {
    return this.on(e, t, n, r, { one: !0 });
  }),
  (rl.removeListener = rl.off =
    function (e, t, n, r) {
      var a = this;
              ...
              var o = function () {
                  ...
                  if (
                    ...
                    (e.afterEmit(e.context, n, i),
                      !1 === l && (i.stopPropagation(), i.preventDefault()));
                  }
                },
                s = 0;
              s < a;
...
var sl = {
    ...
    eventMatches: function (e, t, n) {
      var r = t.qualifier;
      return (
        null == r || (e !== n.target && Q(n.target) && r.matches(n.target))
      );
    },
  ...
  ul = {
    createEmitter: function () {
      for (var e = 0; e < this.length; e++) {
        var t = this[e],
          n = t._private;
        n.emitter || (n.emitter = new nl(sl, t));
      }
      return this;
    },
    emitter: function () {
    ...
    on: function (e, t, n) {
      for (var r = ll(t), a = 0; a < this.length; a++) {
...
var cl = {
    ...
    filter: function (e, t) {
      ...
      if (W(e) || $(e)) return new ns(e).filter(this);
      if (U(e)) {
    ...
    diff: function (e) {
      ...
      return (o(this, i, n), o(i, this, r), { left: n, right: r, both: a });
    },
    add: function (e) {
      var t = this._private.cy;
      if (!e) return this;
    ...
    unmergeAt: function (e) {
      ...
      if (this.length > 1 && !r) {
        var a = this.length - 1,
          i = this[a],
          o = i._private.data.id;
        ((this[a] = void 0), (this[e] = i), n.set(o, { ele: i, index: e }));
      }
  ...
  dl = cl;
((dl.u = dl["|"] = dl["+"] = dl.union = dl.or = dl.add),
  (dl["\\"] =
    dl["!"] =
    dl["-"] =
    dl.difference =
    dl.relativeComplement =
    dl.subtract =
      dl.not),
  (dl.n = dl["&"] = dl["."] = dl.and = dl.intersection = dl.intersect),
  (dl["^"] =
    dl["(+)"] =
    dl["(-)"] =
    dl.symmetricDifference =
    dl.symdiff =
      dl.xor),
  (dl.fnFilter = dl.filterFn = dl.stdFilter = dl.filter),
  (dl.complement = dl.abscomp = dl.absoluteComplement));
var hl = function (e, t) {
    ...
    forEach: function (e, t) {
      if (U(e))
        for (var n = this.length, r = 0; r < n; r++) {
          var a = this[r];
          if (!1 === (t ? e.apply(t, [a, r, this]) : e(a, r, this))) break;
        }
      return this;
    },
    toArray: function () {
...
var pl;
((pl = "undefined"),
  ("undefined" == typeof Symbol ? "undefined" : l(Symbol)) != pl &&
    l(Symbol.iterator) != pl &&
    (fl[Symbol.iterator] = function () {
      var e = this,
...
var gl = lt({ nodeDimensionsIncludeLabels: !1 }),
  vl = {
    layoutDimensions: function (e) {
      var t;
      if (((e = gl(e)), this.takesUpSpace()))
    ...
    layout: function (e) {
      return this.cy().makeLayout(ve({}, e, { eles: this }));
    },
  };
function yl(e, t, n) {
  var r,
...
function bl(e, t) {
  ...
  return function () {
    var t = this[0];
    if (t) return yl(e, n, t);
  };
}
vl.createLayout = vl.makeLayout = vl.layout;
var xl = {
...
function El(e) {
  ...
  return function () {
    ...
    if (a) {
      var o = a._private;
      if (!t(a)) return !1;
      if (a.isNode()) return !i || wl(a, r);
      var s = o.source,
        l = o.target;
      return (
        n(s) && (!i || wl(s, n)) && (s === l || (n(l) && (!i || wl(l, n))))
      );
    }
  };
}
var kl = ml("eleTakesUpSpace", function (e) {
  return (
...
var Tl = ml("eleInteractive", function (e) {
    return (
  ...
  Cl = ml("parentInteractive", function (e) {
    return "visible" === e.pstyle("visibility").value && kl(e);
  });
((xl.interactive = bl(
  "interactive",
  El({ ok: Tl, parentOk: Cl, edgeOkViaNode: kl }),
)),
  (xl.noninteractive = function () {
    var e = this[0];
    if (e) return !e.interactive();
  }));
var Pl = ml("eleVisible", function (e) {
    return (
      "visible" === e.pstyle("visibility").value &&
  ...
  Sl = kl;
((xl.visible = bl("visible", El({ ok: Pl, edgeOkViaNode: Sl }))),
  (xl.hidden = function () {
    var e = this[0];
  ...
  (xl.bypass = xl.css = xl.style),
  (xl.renderedCss = xl.renderedStyle),
  (xl.removeBypass = xl.removeCss = xl.removeStyle),
  (xl.pstyle = xl.parsedStyle));
var Bl = {};
function Dl(e) {
  return function () {
    var t = arguments,
    ...
    if (2 === t.length) {
      var r = t[0],
        a = t[1];
      this.on(e.event, r, a);
    } else if (1 === t.length && U(t[0])) {
      var i = t[0];
      this.on(e.event, i);
    } else if (0 === t.length || (1 === t.length && H(t[0]))) {
...
(_l({
  ...
  (Bl.deselect = Bl.unselect),
  (Bl.grabbed = function () {
    var e = this[0];
    if (e) return e._private.grabbed;
  }),
  _l({ field: "active", on: "activate", off: "unactivate" }),
  _l({ field: "pannable", on: "panify", off: "unpanify" }),
  (Bl.inactive = function () {
    var e = this[0];
      ...
      for (var n = [], r = this.edges(), a = e, i = 0; i < r.length; i++)
        for (
          ...
          var h = c[d],
            ...
            v = p === u && g === l,
            y = l === p && u === g;
          ((a.codirected && v) || (!a.codirected && (v || y))) && n.push(h);
        }
      return this.spawn(n, !0).filter(t);
    }
  );
...
((Al.clearTraversalCache = function () {
  ...
  ve(Al, {
    roots: Ml({ noIncomingEdges: !0 }),
    leaves: Ml({ noOutgoingEdges: !0 }),
    outgoers: ss(Rl({ outgoing: !0 }), "outgoers"),
    successors: Il({ outgoing: !0 }),
    incomers: ss(Rl({ incoming: !0 }), "incomers"),
    predecessors: Il({}),
  }),
  ve(Al, {
    neighborhood: ss(function (e) {
  ...
  (Al.neighbourhood = Al.neighborhood),
  (Al.closedNeighbourhood = Al.closedNeighborhood),
  (Al.openNeighbourhood = Al.openNeighborhood),
  ve(Al, {
    source: ss(function (e) {
      var t,
        n = this[0];
      return (
    ...
    sources: Nl({ attr: "source" }),
    targets: Nl({ attr: "target" }),
  }),
  ve(Al, {
    edgesWith: ss(Ll(), "edgesWith"),
    edgesTo: ss(Ll({ thisIsSrc: !0 }), "edgesTo"),
  }),
  ve(Al, {
    connectedEdges: ss(function (e) {
      for (var t = [], n = 0; n < this.length; n++) {
        var r = this[n];
        if (r.isNode())
    ...
    parallelEdges: ss(zl(), "parallelEdges"),
    codirectedEdges: ss(zl({ codirected: !0 }), "codirectedEdges"),
  }),
  ve(Al, {
...
var Ol = function (e, t) {
    ...
    if (void 0 !== e) {
      var a = new ft(),
        i = !1;
      if (t) {
        if (t.length > 0 && K(t[0]) && !Q(t[0])) {
          i = !0;
          for (var o = [], s = new gt(), l = 0, u = t.length; l < u; l++) {
            var c = t[l];
            null == c.data && (c.data = {});
            var d = c.data;
            if (null == d.id) d.id = it();
      ...
      for (var f = 0, p = t.length; f < p; f++) {
        ...
        if (null != g) {
          ...
          (n && a.has(v)) ||
            (n && a.set(v, { index: this.length, ele: g }),
            (this[this.length] = g),
            this.length++);
        }
      }
      ((this._private = {
        ...
        rebuildMap: function () {
          for (
            var e = (this.lazyMap = new ft()), t = this.eles, n = 0;
            n < t.length;
            n++
          ) {
            var r = t[n];
        ...
        i && !r && this.restore());
    } else tt("A collection must have a reference to the core");
  },
  Vl = (vt.prototype = Ol.prototype = Object.create(Array.prototype));
((Vl.instanceString = function () {
  return "collection";
}),
  (Vl.spawn = function (e, t) {
    return new Ol(this.cy(), e, t);
  }),
        ...
        if ((n.startBatch(), e.data)) {
          ...
          if (t.isEdge()) {
            var i = !1,
              ...
              s = e.data.source,
              l = e.data.target;
            (null != s && s != a.source && ((o.source = "" + s), (i = !0)),
              null != l && l != a.target && ((o.target = "" + l), (i = !0)),
              i && (t = t.move(o)));
          } else {
  ...
  (Vl.restore = function () {
    ...
    for (t = 0; t < e.length; t++) {
      ...
      if ((f.clearTraversalCache(), r || p.removed))
        if (void 0 === g.id) g.id = it();
        else if (G(g.id)) g.id = "" + g.id;
        else {
          if (ne(g.id) || !W(g.id)) {
            (tt("Can not create element with invalid string ID `" + g.id + "`"),
              h());
            continue;
          }
          if (i.hasElementWithId(g.id)) {
            (tt("Can not create second element with ID `" + g.id + "`"), h());
            continue;
          }
        }
      else;
      ...
      if (f.isEdge()) {
        for (
          var m = f, b = ["source", "target"], x = b.length, w = !1, E = 0;
          E < x;
          E++
        ) {
          var k = b[E],
          ...
          (G(T) && (T = g[k] = "" + g[k]),
            null == T || "" === T
              ? (tt("Can not create edge `" + v + "` with unspecified " + k),
                (w = !0))
        ...
        var C = i.getElementById(g.source),
          P = i.getElementById(g.target);
        (C.same(P)
    ...
    for (var S = 0; S < s.length; S++) {
      ...
      if (null != _ || B._private.parent) {
        ...
        if (A.empty()) D.parent = void 0;
          ...
          (rt("Node added with missing parent, reference to parent removed"),
            (D.parent = void 0),
    ...
    if (e.length > 0) {
      for (
        var I = e.length === a.length ? a : new Ol(i, e), N = 0;
        N < I.length;
        N++
      ) {
        var L = I[N];
      ...
      ((o.hasCompoundNodes
        ? i.collection().merge(I).merge(I.connectedNodes()).merge(I.parent())
        : I
      )
  ...
  (Vl.remove = function () {
    ...
    function o(e) {
      ...
      (t && e.removed()) ||
        ...
        e.isNode()
          ? (r.push(e),
            (function (e) {
              for (var t = e._private.edges, n = 0; n < t.length; n++) o(t[n]);
            })(e),
            (function (e) {
    ...
    ((d.ids = {}), n.dirtyCompoundBoundsCache(), t && i.removeFromPool(r));
...
var Fl = {
  add: function (e) {
    ...
    if ($(e)) {
      ...
      t = new Ol(n, e);
    } else if (K(e) && (H(e.nodes) || H(e.edges))) {
      for (
        ...
        if (H(f))
          for (var p = 0, g = f.length; p < g; p++) {
            var v = ve({ group: h }, f[p]);
            l.push(v);
          }
      }
      t = new Ol(n, l);
    } else {
      t = new vt(n, e).collection();
    }
    return t;
  },
  remove: function (e) {
...
/*! Bezier curve function generator. Copyright Gaetan Renaudeau. MIT License: http://en.wikipedia.org/wiki/MIT_License */ function Xl(
  e,
  t,
  n,
  r,
...
/*! Runge-Kutta spring physics function generator. Adapted from Framer.js, copyright Koen Bok. MIT License: http://en.wikipedia.org/wiki/MIT_License */ var jl =
    (function () {
      function e(e) {
  ...
  ql = {
    ...
    ease: Yl(0.25, 0.1, 0.25, 1),
    "ease-in": Yl(0.42, 0, 1, 1),
    "ease-out": Yl(0, 0, 0.58, 1),
    "ease-in-out": Yl(0.42, 0, 0.58, 1),
    "ease-in-sine": Yl(0.47, 0, 0.745, 0.715),
    "ease-out-sine": Yl(0.39, 0.575, 0.565, 1),
    "ease-in-out-sine": Yl(0.445, 0.05, 0.55, 0.95),
    "ease-in-quad": Yl(0.55, 0.085, 0.68, 0.53),
    "ease-out-quad": Yl(0.25, 0.46, 0.45, 0.94),
    "ease-in-out-quad": Yl(0.455, 0.03, 0.515, 0.955),
    "ease-in-cubic": Yl(0.55, 0.055, 0.675, 0.19),
    "ease-out-cubic": Yl(0.215, 0.61, 0.355, 1),
    "ease-in-out-cubic": Yl(0.645, 0.045, 0.355, 1),
    "ease-in-quart": Yl(0.895, 0.03, 0.685, 0.22),
    "ease-out-quart": Yl(0.165, 0.84, 0.44, 1),
    "ease-in-out-quart": Yl(0.77, 0, 0.175, 1),
    "ease-in-quint": Yl(0.755, 0.05, 0.855, 0.06),
    "ease-out-quint": Yl(0.23, 1, 0.32, 1),
    "ease-in-out-quint": Yl(0.86, 0, 0.07, 1),
    "ease-in-expo": Yl(0.95, 0.05, 0.795, 0.035),
    "ease-out-expo": Yl(0.19, 1, 0.22, 1),
    "ease-in-out-expo": Yl(1, 0, 0, 1),
    "ease-in-circ": Yl(0.6, 0.04, 0.98, 0.335),
    "ease-out-circ": Yl(0.075, 0.82, 0.165, 1),
    "ease-in-out-circ": Yl(0.785, 0.135, 0.15, 0.86),
    spring: function (e, t, n) {
      if (0 === n) return ql.linear;
      var r = jl(e, t, n);
      return function (e, t, n) {
        return e + (t - e) * r(n);
      };
...
function Hl(e, t, n, r, a) {
  ...
  var o = Ul(e, a),
    s = Ul(t, a);
  if (G(o) && G(s)) return Wl(i, o, s, n, r);
  if (H(o) && H(s)) {
...
function Kl(e, t, n, r) {
  var a = !r,
    ...
    u = (r ? e : e.cy()).style();
  if (!o.easingImpl)
    if (null == s) o.easingImpl = ql.linear;
    else {
      var c, d, h;
      if (W(s)) c = u.parse("transition-timing-function", s).value;
      else c = s;
      (W(c)
        ? ((d = c), (h = []))
        : ((d = c[1]),
        ...
        h.length > 0
          ? ("spring" === d && h.push(o.duration),
            (o.easingImpl = ql[d].apply(null, h)))
          : (o.easingImpl = ql[d]));
    }
  var f,
    p = o.easingImpl;
  if (
    ...
    if (v && a && !e.locked()) {
      var y = {};
      (Gl(g.x, v.x) && (y.x = Hl(g.x, v.x, f, p)),
        Gl(g.y, v.y) && (y.y = Hl(g.y, v.y, f, p)),
        e.position(y));
    }
    var m = o.startPan,
      b = o.pan,
      ...
      w = null != b && r;
    w &&
      (Gl(m.x, b.x) && (x.x = Hl(m.x, b.x, f, p)),
      Gl(m.y, b.y) && (x.y = Hl(m.y, b.y, f, p)),
      e.emit("pan"));
    var E = o.startZoom,
      k = o.zoom,
      T = null != k && r;
    (T &&
      (Gl(E, k) && (i.zoom = $t(i.minZoom, Hl(E, k, f, p), i.maxZoom)),
      e.emit("zoom")),
      (w || T) && e.emit("viewport"));
    var C = o.style;
    if (C && C.length > 0 && a) {
      for (var P = 0; P < C.length; P++) {
        var S = C[P],
          ...
          D = S,
          _ = o.startStyle[B],
          A = Hl(_, D, f, p, u.properties[_.name]);
...
function Gl(e, t) {
  return null != e && null != t && (!(!G(e) || !G(t)) || !(!e || !t));
}
function Zl(e, t, n, r) {
  var a = t._private;
...
var Ql = {
  ...
  tu = {
    createEmitter: function () {
      var e = this._private;
      return (e.emitter || (e.emitter = new nl(Jl, this)), this);
    },
    emitter: function () {
      return this._private.emitter;
    },
    on: function (e, t, n) {
      return (this.emitter().on(e, eu(t), n), this);
    },
    removeListener: function (e, t, n) {
      return (this.emitter().removeListener(e, eu(t), n), this);
    },
    removeAllListeners: function () {
      return (this.emitter().removeAllListeners(), this);
    },
    one: function (e, t, n) {
      return (this.emitter().one(e, eu(t), n), this);
    },
    once: function (e, t, n) {
      return (this.emitter().one(e, eu(t), n), this);
    },
  ...
  layout: function (e) {
    ...
    if (null != e)
      if (null != e.name) {
        ...
        if (null != r) {
          var a;
          a = W(e.eles) ? t.$(e.eles) : null != e.eles ? e.eles : t.$();
      ...
      } else tt("A `name` must be specified to make a layout");
    else tt("Layout options must be specified to make a layout");
  },
};
  ...
  collection: function (e, t) {
    return W(e)
      ...
      : $(e)
        ? e.collection()
        : H(e)
          ? (t || (t = {}), new Ol(this, e, t.unique, t.removed))
          : new Ol(this);
  },
  nodes: function (e) {
...
((lu.apply = function (e) {
  ...
  (lu.getPropertiesDiff = function (e, t) {
    var n = this,
    ...
    for (var o = [], s = {}, l = 0; l < n.length; l++) {
      ...
      if (h || (d && f)) {
        var p = void 0;
        (h && f) || h ? (p = u.properties) : f && (p = u.mappedProperties);
        for (var g = 0; g < p.length; g++) {
          for (var v = p[g], y = v.name, m = !1, b = l + 1; b < n.length; b++) {
            var x = n[b];
            if (t[b] === uu && (m = null != x.properties[v.name])) break;
          }
  ...
  (lu.getContextMeta = function (e) {
    for (
      ...
      var o = n[i];
      r += o.selector && o.selector.matches(e) ? uu : "f";
    }
    return (
  ...
  (lu.applyContextStyle = function (e, t, n) {
    for (
  ...
  (lu.updateStyleHints = function (e) {
    var t = e._private,
      n = this,
    ...
    for (
      var d,
        h = function (e, n) {
          return (t.styleKeys[n][0] = Oe(e, t.styleKeys[n][0]));
        },
        f = function (e, n) {
          return (t.styleKeys[n][1] = Ve(e, t.styleKeys[n][1]));
        },
        p = function (e, t) {
          (h(e, t), f(e, t));
        },
      ...
      if (null != m) {
        ...
        if (x.number && C && !x.multiple)
          (p(
            -128 < (d = T ? E : k) && d < 128 && Math.floor(d) !== d
              ? 2e9 - ((1024 * d) | 0)
              : d,
            w,
          ),
    ...
    for (var S, B, D = [Ne, Le], _ = 0; _ < a.length; _++) {
      var A = a[_],
        M = t.styleKeys[A];
      ((D[0] = Oe(M[0], D[0])), (D[1] = Ve(M[1], D[1])));
    }
    t.styleKey = ((S = D[0]), (B = D[1]), 2097152 * S + B);
    var R = t.styleKeys;
    t.labelDimsKey = Fe(R.labelDimensions);
    var I = i(e, ["label"], R.labelDimensions);
    if (
      ((t.labelKey = Fe(I)), (t.labelStyleKey = Fe(Xe(R.commonLabel, I))), !s)
    ) {
      var N = i(e, ["source-label"], R.labelDimensions);
      ((t.sourceLabelKey = Fe(N)),
        (t.sourceLabelStyleKey = Fe(Xe(R.commonLabel, N))));
      var L = i(e, ["target-label"], R.labelDimensions);
      ((t.targetLabelKey = Fe(L)),
        (t.targetLabelStyleKey = Fe(Xe(R.commonLabel, L))));
    }
    if (s) {
      var z = t.styleKeys,
        O = z.nodeBody,
        ...
        W = [O, V, F, X, j, Y, q]
          ...
          .reduce(Xe, [Ne, Le]);
      ((t.nodeKey = Fe(W)),
        (t.hasPie = null != Y && Y[0] !== Ne && Y[1] !== Le),
        (t.hasStripe = null != q && q[0] !== Ne && q[1] !== Le));
    }
    return o !== t.styleKey;
  }),
  (lu.clearStyleHints = function (e) {
    var t = e._private;
    ((t.styleCxtKey = ""),
      (t.styleKeys = {}),
      (t.styleKey = null),
  ...
  (lu.applyParsedProperty = function (e, t) {
    var n,
      r = this,
      a = t,
      i = e._private.style,
    ...
    if (a.deleteBypass)
      return u ? !!u.bypass && ((i[a.name] = u.bypassed), p(), !0) : (p(), !0);
    var g = function () {
      rt(
  ...
  (lu.updateTransitions = function (e, t) {
    var n = this,
      r = e._private,
      ...
      for (var s = {}, l = !1, u = 0; u < a.length; u++) {
        ...
        if (h) {
          var f = h.prev,
            ...
            y = 1e-6;
          f &&
            (G(f.pfValue) && G(p.pfValue)
              ? ((g = p.pfValue - f.pfValue), (v = f.pfValue + y * g))
              : G(f.value) && G(p.value)
                ? ((g = p.value - f.value), (v = f.value + y * g))
                : H(f.value) &&
                  H(p.value) &&
                  ((g =
                    f.value[0] !== p.value[0] ||
  ...
  (lu.checkTrigger = function (e, t, n, r, a, i) {
    var o = this.properties[t],
      s = a(o);
    e.removed() || (null != s && s(n, r, e) && i(o));
  }),
  (lu.checkZOrderTrigger = function (e, t, n, r) {
    var a = this;
    this.checkTrigger(
      e,
      t,
  ...
  (lu.checkBoundsTrigger = function (e, t, n, r) {
    this.checkTrigger(
      e,
      t,
      n,
  ...
  (lu.checkConnectedEdgesBoundsTrigger = function (e, t, n, r) {
    this.checkTrigger(
      e,
      t,
      n,
  ...
  (lu.checkParallelEdgesBoundsTrigger = function (e, t, n, r) {
    this.checkTrigger(
      e,
      t,
      n,
  ...
  (lu.checkTriggers = function (e, t, n, r) {
    (e.dirtyStyleCache(),
...
var cu = {
    applyBypass: function (e, t, n, r) {
      ...
      for (var g = !1, v = 0; v < e.length; v++) {
        for (var y = e[v], m = {}, b = void 0, x = 0; x < a.length; x++) {
          var w = a[x];
          if (r) {
            var E = y.pstyle(w.name);
            b = m[w.name] = { prev: E };
          }
          ((g = this.applyParsedProperty(y, at(w)) || g),
    ...
    removeBypasses: function (e, t, n) {
      for (var r = 0; r < e.length; r++) {
        ...
        (this.updateStyleHints(a), n && this.updateTransitions(a, i, true));
      }
    },
  },
  du = {
    ...
    getRawStyle: function (e, t) {
      ...
      if ((e = e[0])) {
        for (var r = {}, a = 0; a < n.properties.length; a++) {
          ...
          null != o && ((r[i.name] = o), (r[oe(i.name)] = o));
        }
        return r;
      }
    },
    ...
    getAnimationStartStyle: function (e, t) {
      for (var n = {}, r = 0; r < t.length; r++) {
        var a = t[r].name,
          i = e.pstyle(a);
        (void 0 !== i &&
          (i = K(i) ? this.parse(a, i.strValue) : this.parse(a, i)),
          i && (n[a] = i));
      }
      return n;
    },
    ...
    getNonDefaultPropertiesHash: function (e, t, n) {
      ...
      for (s = 0; s < t.length; s++)
        if (((r = t[s]), null != (a = e.pstyle(r, !1))))
          if (null != a.pfValue) ((u[0] = Oe(o, u[0])), (u[1] = Ve(o, u[1])));
          else
...
var fu = {
    ...
    json: function () {
      for (var e = [], t = this.defaultLength; t < this.length; t++) {
        for (
          var n = this[t], r = n.selector, a = n.properties, i = {}, o = 0;
          o < a.length;
          o++
        ) {
          var s = a[o];
      ...
      for (i = i.replace(/[/][*](\s|.)+?[*][/]/g, ""); ;) {
        ...
        for (var h = []; ;) {
          ...
          if (this.properties[p])
            a.parse(p, g)
              ? (h.push({ name: p, val: g }), s())
              : (rt("Skipping property: Invalid property definition in: " + r),
                s());
          else (rt("Skipping property: Invalid property name in: " + r), s());
        }
        if (d) {
          o();
          break;
...
(!(function () {
  var e = ce,
    ...
    a = function (r) {
      var a =
        e + "|\\w+|" + t + "|" + n + "|\\#[0-9a-fA-F]{3}|\\#[0-9a-fA-F]{6}";
      return (
        "^" +
        r +
        "\\s*\\(([\\w\\.]+)\\s*\\,\\s*(" +
  ...
  var o = {
    ...
    l = [
      ...
      { name: "text-rotation", type: s.textRotation, triggersBounds: o.any },
      {
        name: "text-margin-x",
    ...
    d = [
      ...
      { name: "text-transform", type: s.textTransform, triggersBounds: o.any },
      ...
      { name: "line-height", type: s.positiveNumber, triggersBounds: o.any },
    ],
    h = [
      ...
      { name: "text-background-padding", type: s.size, triggersBounds: o.any },
      ...
      { name: "text-border-style", type: s.borderStyle, triggersBounds: o.any },
      {
      ...
      { name: "text-metrics", type: s.textMetrics },
    ...
    f = [
      ...
      { name: "box-selection", type: s.boxSelection, triggersZOrder: o.any },
    ],
    p = [
      {
        name: "display",
      ...
      { name: "opacity", type: s.zeroOneNumber, triggersZOrder: o.zeroNonZero },
      ...
      { name: "z-index-compare", type: s.zIndexCompare, triggersZOrder: o.any },
    ...
    g = [
      ...
      { name: "overlay-shape", type: s.overlayShape, triggersBounds: o.any },
    ...
    v = [
      ...
      { name: "underlay-shape", type: s.overlayShape, triggersBounds: o.any },
    ...
    b = [
      ...
      { name: "background-gradient-direction", type: s.gradientDirection },
      { name: "padding", type: s.sizeMaybePercent, triggersBounds: o.any },
      {
    ...
    T = [
      ...
      { name: "haystack-radius", type: s.zeroOneNumber, triggersBounds: o.any },
      { name: "source-endpoint", type: s.edgeEndpoint, triggersBounds: o.any },
      { name: "target-endpoint", type: s.edgeEndpoint, triggersBounds: o.any },
      { name: "control-point-step-size", type: s.size, triggersBounds: o.any },
      {
        name: "control-point-distances",
        type: s.bidirectionalSizes,
        triggersBounds: o.any,
      },
      { name: "control-point-weights", type: s.numbers, triggersBounds: o.any },
      {
      ...
      { name: "taxi-turn-min-distance", type: s.size, triggersBounds: o.any },
      { name: "taxi-direction", type: s.axisDirection, triggersBounds: o.any },
      { name: "taxi-radius", type: s.number, triggersBounds: o.any },
      { name: "edge-distances", type: s.edgeDistances, triggersBounds: o.any },
      { name: "arrow-scale", type: s.positiveNumber, triggersBounds: o.any },
  ...
  for (var B = 1; B <= gu.pieBackgroundN; B++)
  ...
  var R = (gu.properties = [].concat(
    ...
    N = (gu.propertyGroupNames = {});
  (gu.propertyGroupKeys = Object.keys(I)).forEach(function (e) {
  ...
  gu.propertyNames = R.map(function (e) {
    return e.name;
  });
  ...
  (gu.getDefaultProperty = function (e) {
    return this.getDefaultProperties()[e];
  }),
  (gu.getDefaultProperties = function () {
    var e = this._private;
    ...
    for (
      var t = ve(
          ...
          [
            ...
            for (var n = 1; n <= gu.pieBackgroundN; n++) {
          ...
          [
            ...
            for (var n = 1; n <= gu.stripeBackgroundN; n++) {
              var r = t.name.replace("{{i}}", n),
                a = t.value;
              e[r] = a;
            }
          ...
          [
            ...
            return (
              gu.arrowPrefixes.forEach(function (n) {
                var r = n + "-" + t.name,
                  a = t.value;
                e[r] = a;
              }),
  ...
  (gu.addDefaultStylesheet = function () {
...
var vu = {
  parse: function (e, t, n, r) {
    var a = this;
    if (U(t)) return a.parseImplWarn(e, t, n, r);
    var i,
      o = qe(
        e,
        "" + t,
    ...
    return (
      ...
      (n || "mapping" === r) && (i = at(i)) && (i.value = at(i.value)),
      i
    );
  },
  parseImplWarn: function (e, t, n, r) {
    ...
    return (
      a ||
        null == t ||
        rt("The style property `".concat(e, ": ").concat(t, "` is invalid")),
      !a ||
        ("width" !== a.name && "height" !== a.name) ||
        "label" !== t ||
        rt("The style value of `label` is deprecated for `" + a.name + "`"),
      a
    );
  },
};
vu.parseImpl = function (e, t, n, r) {
  var a = this;
  e = ie(e);
  ...
  if (d.multiple && "multiple" !== r) {
    var m;
    if (
      ((m = l ? t.split(/\s+/) : H(t) ? t : [t]),
      d.evenMultiple && m.length % 2 != 0)
    )
      return null;
    for (var b = [], x = [], w = [], E = "", k = !1, T = 0; T < m.length; T++) {
    ...
    return d.validate && !d.validate(b, x)
      ...
      : d.singleEnum && k
        ? 1 === b.length && W(b[0])
          ...
          : null
        : { name: e, value: b, pfValue: w, strValue: E, bypass: n, units: x };
  }
  var P,
    S,
    B = function () {
  ...
  if (d.number) {
    ...
    if (d.integer && (!G((S = t)) || Math.floor(S) !== S)) return null;
    if (
    ...
    return (
      d.unitless || ("px" !== D && "em" !== D)
        ? (R.pfValue = t)
        : (R.pfValue = "px" !== D && D ? this.getEmSizeInPixels() * t : t),
  ...
  if (d.propList) {
    ...
    if ("none" === N);
      ...
      for (var L = N.split(/\s*,\s*|\s+/), z = 0; z < L.length; z++) {
        ...
        a.properties[O]
          ? I.push(O)
          : rt("`" + O + "` is not a valid property name");
      }
  ...
  if (d.regex || d.regexes) {
    ...
    for (var X = d.regexes ? d.regexes : [d.regex], j = 0; j < X.length; j++) {
...
var yu = function (e) {
    if (!(this instanceof yu)) return new yu(e);
    ee(e)
...
((mu.instanceString = function () {
  ...
  (yu.fromJson = function (e, t) {
    var n = new yu(e);
    return (n.fromJson(t), n);
  }),
  (yu.fromString = function (e, t) {
    return new yu(e).fromString(t);
  }),
  [lu, cu, du, hu, fu, pu, gu, vu].forEach(function (e) {
    ve(mu, e);
  }),
  (yu.types = mu.types),
  (yu.properties = mu.properties),
  (yu.propertyGroups = mu.propertyGroups),
  (yu.propertyGroupNames = mu.propertyGroupNames),
  (yu.propertyGroupKeys = mu.propertyGroupKeys));
var bu = {
    style: function (e) {
    ...
    setStyle: function (e) {
      ...
      return (
        te(e)
          ...
          : H(e)
            ? (t.style = yu.fromJson(this, e))
            : W(e)
              ? (t.style = yu.fromString(this, e))
              : (t.style = yu(this)),
        t.style
      );
    },
  ...
  xu = {
    ...
    getFitViewport: function (e, t) {
      if (
        ...
        if (W(e)) {
          var a = e;
          e = this.$(a);
        } else if (K((r = e)) && G(r.x1) && G(r.x2) && G(r.y1) && G(r.y2)) {
          var i = e;
          (((n = { x1: i.x1, y1: i.y1, x2: i.x2, y2: i.y2 }).w = n.x2 - n.x1),
            (n.h = n.y2 - n.y1));
        } else $(e) || (e = this.mutableElements());
        if (!$(e) || !e.empty()) {
          n = n || e.boundingBox();
          var o,
            s = this.width(),
    ...
    zoomRange: function (e, t) {
      ...
      return (
        G(e) && G(t) && e <= t
          ...
          : G(e) && void 0 === t && e <= n.maxZoom
            ? (n.minZoom = e)
            : G(t) && void 0 === e && t >= n.minZoom && (n.maxZoom = t),
        this
      );
    },
    minZoom: function (e) {
    ...
    viewport: function (e) {
      var t = this._private,
        ...
        o = !1;
      if (!e) return this;
      if ((G(e.zoom) || (n = !1), K(e.pan) || (r = !1), !n && !r)) return this;
      if (n) {
        var s = e.zoom;
      ...
      if (r && (!i || !e.cancelOnFailedZoom) && t.panningEnabled) {
        var l = e.pan;
        (G(l.x) && ((t.pan.x = l.x), (o = !1)),
          G(l.y) && ((t.pan.y = l.y), (o = !1)),
          o || a.push("pan"));
      }
      return (
        a.length > 0 &&
...
((xu.centre = xu.center),
  (xu.autolockNodes = xu.autolock),
  (xu.autoungrabifyNodes = xu.autoungrabify));
var wu = {
  data: mo.data({
    field: "data",
    bindingEvent: "data",
...
var Eu = function (e) {
    ...
    (n && (n._cyreg = r), (r.cy = t));
    var i = void 0 !== c && void 0 !== n && !e.headless,
      o = e;
    ((o.layout = ve({ name: i ? "grid" : "null" }, o.layout)),
      (o.renderer = ve({ name: i ? "canvas" : "null" }, o.renderer)));
    var s = function (e, t, n) {
      ...
      l = (this._private = {
        ...
        zoom: G(o.zoom) ? o.zoom : 1,
        pan: {
          x: K(o.pan) && G(o.pan.x) ? o.pan.x : 0,
          y: K(o.pan) && G(o.pan.y) ? o.pan.y : 0,
        },
        animation: { current: [], queue: [] },
        hasCompoundNodes: !1,
    ...
    var u = ve({}, o, o.renderer);
    t.initRenderer(u);
    !(function (e, t) {
      if (e.some(re)) return Wr.all(e).then(t);
      t(e);
      ...
      (l.styleEnabled && t.style().append(n),
        (function (e, n, r) {
          ...
          var i = ve({}, t._private.options.layout);
...
(ve(ku, {
  ...
  window: function () {
    ...
    return void 0 === e || null == e ? c : e.defaultView || c;
  },
  mount: function (e) {
    if (null != e) {
      var t = this,
  ...
  options: function () {
    return at(this._private.options);
  },
  json: function (e) {
    var t = this,
      n = t._private,
          ...
          i = function (e, n) {
            for (var r = [], i = [], o = 0; o < e.length; o++) {
              ...
              if (s.data.id) {
                ...
                rt("cy.json() cannot handle elements without an ID attribute");
            }
            t.add(r);
  ...
  [Fl, Ql, tu, nu, ru, au, ou, su, bu, xu, wu].forEach(function (e) {
    ve(ku, e);
  }));
var Tu = {
    fit: !0,
...
Bu.prototype.run = function () {
  var e,
    ...
    l = !!t.boundingBox,
    u = Qt(l ? t.boundingBox : structuredClone(n.extent()));
  if ($(t.roots)) e = t.roots;
  else if (H(t.roots)) {
  ...
  var y = [],
    ...
    b = function (e, t) {
      null == y[t] && (y[t] = []);
      var n = y[t].length;
      (y[t].push(e), Su(e, { index: n, depth: t }));
    };
  i.bfs({
    roots: e,
    directed: t.directed,
  ...
  var k = function (e) {
      for (var t = y[e], n = 0; n < t.length; n++) {
        var r = t[n];
        null != r ? Su(r, { depth: e, index: n }) : (t.splice(n, 1), n--);
      }
    },
    T = function (e, n) {
      for (
  ...
  var N = {},
    L = function (e) {
      if (N[e.id()]) return N[e.id()];
      for (
        var t = Pu(e).depth, n = e.neighborhood(), r = 0, i = 0, o = 0;
        o < n.length;
        o++
      ) {
        var s = n[o];
    ...
    z = function (e, t) {
      var n = L(e) - L(t);
      return 0 === n ? ge(e.id(), t.id()) : n;
    };
  void 0 !== t.depthSort && (z = t.depthSort);
  for (var O = y.length, V = 0; V < O; V++) (y[V].sort(z), k(V));
  for (var F = [], X = 0; X < x.length; X++) F.push(x[X]);
  F.length &&
    (y.unshift(F),
    (O = y.length),
    (function () {
      for (var e = 0; e < O; e++) k(e);
    })());
  for (var j = 0, Y = 0; Y < O; Y++) j = Math.max(y[Y].length, j);
  var q = u.x1 + u.w / 2,
    U = u.y1 + u.h / 2,
    K = a.reduce(
      function (e, n) {
      ...
      return Ue(
        (function (e) {
          var n = Pu(e),
            ...
            a = n.index;
          if (t.circle) {
            var i = Math.min(u.w / 2 / O, u.h / 2 / O),
              o =
                (i = Math.max(i, _)) * r +
                i -
                (O > 0 && y[0].length <= 3 ? i / 2 : 0),
              s = ((2 * Math.PI) / y[r].length) * a;
            return (
              0 === r && 1 === y[0].length && (o = 1),
              { x: q + o * Math.cos(s), y: U + o * Math.sin(s) }
            );
          }
          var c = y[r].length,
            d = Math.max(
              1 === c
                ? 0
                : l
                  ? (u.w - 2 * t.padding - K.w) / ((t.grid ? Z : c) - 1)
                  : (u.w - 2 * t.padding - K.w) / ((t.grid ? Z : c) + 1),
              _,
            );
          return {
...
Ru.prototype.run = function () {
  ...
  for (var p = 0; p < i.length; p++) {
    var g = i[p].layoutDimensions(t);
    c = Math.max(c, g.w, g.h);
  }
  u.sort(function (e, t) {
    return t.value - e.value;
  });
  for (var v = t.levelWidth(i), y = [[]], m = y[0], b = 0; b < u.length; b++) {
    var x = u[b];
    if (m.length > 0)
  ...
  for (var T = 0, C = 0; C < y.length; C++) {
    var P = y[C],
      S = void 0 === t.sweep ? 2 * Math.PI - (2 * Math.PI) / P.length : t.sweep,
...
function Nu(e) {
  ((this.options = ve({}, Iu, e)), (this.options.layout = this));
...
((Nu.prototype.run = function () {
  ...
  ((n.stopped = !1),
    ...
    (Au = !0 === e.debug));
  var r = Lu(t, n, e);
  (Au && undefined(r), e.randomize && Vu(r));
  var a = Ie(),
    i = function () {
      (Xu(r, t, e), !0 === e.fit && t.fit(e.padding));
    },
    o = function (t) {
      return (
  ...
  if (!0 === e.animate) {
    var c = function () {
      ...
      u ? (Ie() - a >= e.animationThreshold && i(), Re(c)) : (ec(r, e), s());
    };
    c();
  } else {
    for (; u;) ((u = o(l)), l++);
...
var Lu = function (e, t, n) {
    ...
    for (u = 0; u < o.nodeSize; u++) {
      ...
      (((R = {}).isLocked = y.locked()),
        ...
        (R.nodeRepulsion = U(n.nodeRepulsion)
          ? n.nodeRepulsion(y)
          : n.nodeRepulsion),
    ...
    for (u = 0; u < o.nodeSize; u++) {
      ...
      null != m
        ...
        : ((f[++g] = y.id), v.push(y.id));
    }
    for (o.graphSet.push(v); p <= g;) {
      var b = f[p++],
        x = o.idToIndex[b],
        w = o.layoutNodes[x].children;
      if (w.length > 0) {
        o.graphSet.push(w);
        for (u = 0; u < w.length; u++) f[++g] = w[u];
      }
    }
    ...
    for (u = 0; u < o.edgeSize; u++) {
      ...
      var P = U(n.idealEdgeLength) ? n.idealEdgeLength(T) : n.idealEdgeLength,
        S = U(n.edgeElasticity) ? n.edgeElasticity(T) : n.edgeElasticity,
        B = o.idToIndex[C.sourceId],
        D = o.idToIndex[C.targetId];
      if (o.indexToGraph[B] != o.indexToGraph[D]) {
        for (
          var _ = zu(C.sourceId, C.targetId, o),
            A = o.graphSet[_],
            M = 0,
            R = o.layoutNodes[B];
          -1 === A.indexOf(R.id);
  ...
  Vu = function (e, t) {
    for (
      ...
      0 !== i.children.length ||
        i.isLocked ||
        ((i.positionX = Math.random() * n), (i.positionY = Math.random() * r));
    }
  },
  Fu = function (e, t, n) {
    var r = e.boundingBox,
  ...
  ju = function (e, t, n) {
    (Yu(e, t), Ku(e), Gu(e, t), Zu(e), $u(e));
  },
  Yu = function (e, t) {
    for (var n = 0; n < e.graphSet.length; n++)
      for (var r = e.graphSet[n], a = r.length, i = 0; i < a; i++)
        for (var o = e.layoutNodes[e.idToIndex[r[i]]], s = i + 1; s < a; s++) {
  ...
  Wu = function (e, t, n, r) {
    if (e.cmptId === t.cmptId || n.isCompound) {
      ...
      0 === a && 0 === i && ((a = qu(1)), (i = qu(1)));
      var o = Uu(e, t, a, i);
      if (o > 0)
        var s = ((u = r.nodeOverlap * o) * a) / (g = Math.sqrt(a * a + i * i)),
          l = (u * i) / g;
      else {
        var u,
          c = Hu(e, a, i),
          ...
          p = h * h + f * f,
          g = Math.sqrt(p);
        ((s = ((u = (e.nodeRepulsion + t.nodeRepulsion) / p) * h) / g),
          (l = (u * f) / g));
      }
  ...
  $u = function (e, t) {
    ...
    for (n = 0; n < e.nodeSize; n++) {
      if (!(0 < (a = e.layoutNodes[n]).children.length || a.isLocked)) {
        var r = Qu(a.offsetX, a.offsetY, e.temperature);
        ((a.positionX += r.x),
          (a.positionY += r.y),
          (a.offsetX = 0),
          (a.offsetY = 0),
    ...
    for (a = 0; a < r.length; a++) {
      ...
      if ((g = r[a])) {
        ...
        ((c += g.w + t.componentSpacing),
          ...
          (f = Math.max(f, g.h)),
          h > p && ((d += f + t.componentSpacing), (c = 0), (h = 0), (f = 0)));
      }
    }
  },
  tc = {
...
nc.prototype.run = function () {
  ...
  if (0 === i.h || 0 === i.w)
    ...
    a.layoutPositions(this, t, function (e, t) {
      ...
      var a = R[e.id()];
      if (a) ((n = a.col * m + m / 2 + i.x1), (r = a.row * b + b / 2 + i.y1));
      else {
        for (; B(_, A);) M();
        ((n = A * m + m / 2 + i.x1), (r = _ * b + b / 2 + i.y1), D(_, A), M());
      }
      return { x: n, y: r };
    });
  }
...
var rc = { ready: function () {}, stop: function () {} };
function ac(e) {
  this.options = ve({}, rc, e);
}
...
var uc = [
  { name: "breadthfirst", impl: Bu },
  { name: "circle", impl: _u },
  { name: "concentric", impl: Ru },
  { name: "cose", impl: Nu },
  { name: "grid", impl: nc },
  { name: "null", impl: ac },
  { name: "preset", impl: oc },
  ...
  pc = {
      ...
      function m(n) {
        ...
        if (
          ...
          for (var x = i.allpts, w = 0; w + 3 < x.length; w += 2)
            if (
              dn(e, t, x[w], x[w + 1], x[w + 2], x[w + 3], g) &&
              p > (r = pn(e, t, x[w], x[w + 1], x[w + 2], x[w + 3]))
            )
              return (v(n, r), !0);
        } else if (
          "bezier" === i.edgeType ||
      ...
      function x(n, r) {
        ...
        if ("yes" === n.pstyle("text-events").strValue && l) {
          ...
          if (d) {
            ...
            if (gn(e, t, B)) return (v(n), !0);
          } else if (an(s, e, t)) return (v(n), !0);
        }
      }
      n && (l = l.interactive);
    ...
    getAllInBox: function (e, t, n, r) {
      var a = this.getCachedZSortedEles().interactive,
        ...
        c = Math.min(t, r),
        d = Math.max(t, r),
        h = Qt({ x1: (e = l), y1: (t = c), x2: (n = u), y2: (r = d) }),
        f = [
          { x: h.x1, y: h.y1 },
          { x: h.x2, y: h.y1 },
          { x: h.x2, y: h.y2 },
      ...
      function v(e, t) {
        ...
        if (!a) return null;
        var i = g(n.rscratch, "labelX", t),
          s = g(n.rscratch, "labelY", t),
          l = g(n.rscratch, "labelAngle", t),
      ...
      for (var m = 0; m < a.length; m++) {
        ...
        if (b.isNode()) {
          ...
          if ("contain" === E) {
            ...
            if (k && w) {
              var S = v(x);
              S && Mn(S, f) && (s.push(x), (P = !0));
            }
            !P && sn(h, C) && s.push(x);
          } else if ("overlap" === E && rn(h, C)) {
            var B = x.boundingBox({
              includeNodes: !0,
              includeEdges: !0,
              includeLabels: !1,
          ...
          if ("contain" === R) {
            if (
              null != M.startX &&
              null != M.startY &&
              !an(h, M.startX, M.startY)
            )
              continue;
            if (null != M.endX && null != M.endY && !an(h, M.endX, M.endY))
              continue;
            if (
              "bezier" === M.edgeType ||
              ...
              N && s.push(_);
            } else "straight" === M.edgeType && s.push(_);
          } else if ("overlap" === R) {
            var z = !1;
            if (
              null != M.startX &&
              ...
              null != M.endX &&
              null != M.endY &&
              (an(h, M.startX, M.startY) || an(h, M.endX, M.endY))
            )
              (s.push(_), (z = !0));
            ...
            if (!z) {
              var F =
                A.rstyle.bezierPts || A.rstyle.linePts || A.rstyle.haystackPts;
              if (
                ((!F || F.length < 2) &&
                  "straight" === M.edgeType &&
                  null != M.startX &&
              ...
              for (var X = 0; X < F.length - 1; X++) {
                for (var j = F[X], Y = F[X + 1], q = 0; q < p.length; q++) {
                  var W = i(p[q], 2);
                  if (y(j, Y, W[0], W[1])) {
                    (s.push(_), (z = !0));
                    break;
  ...
  gc = {
    calculateArrowAngles: function (e) {
      ...
      if (
        ...
        var p = s.allpts;
        ((t = r - Gt(p[0], p[2], p[4], 0.1)),
          (n = a - Gt(p[1], p[3], p[5], 0.1)));
      } else ((t = r - g), (n = a - v));
      s.srcArrowAngle = Yt(t, n);
      var g = s.midX,
        v = s.midY;
      if (
        (l && ((g = (r + i) / 2), (v = (a + o) / 2)),
        ...
        if ((s.ctrlpts.length / 2) % 2 == 0) {
          ...
          ((m = Gt(p[T], p[k], p[E], 0)),
            (b = Gt(p[T + 1], p[k + 1], p[E + 1], 0)),
            (x = Gt(p[T], p[k], p[E], 1e-4)),
            (w = Gt(p[T + 1], p[k + 1], p[E + 1], 1e-4)));
        } else {
          var k, T;
          E = (k = p.length / 2 - 1) + 2;
          ((m = Gt(p[(T = k - 2)], p[k], p[E], 0.4999)),
            (b = Gt(p[T + 1], p[k + 1], p[E + 1], 0.4999)),
            (x = Gt(p[T], p[k], p[E], 0.5)),
            (w = Gt(p[T + 1], p[k + 1], p[E + 1], 0.5)));
        }
        ((t = x - m), (n = w - b));
      }
      if (
        ((s.midtgtArrowAngle = Yt(t, n)),
        (s.midDispX = t),
        (s.midDispY = n),
        (t *= -1),
        (n *= -1),
      ...
      if (((s.midsrcArrowAngle = Yt(t, n)), d))
        ((t = i - s.segpts[s.segpts.length - 2]),
          (n = o - s.segpts[s.segpts.length - 1]));
      else if (c || h || f || u) {
        var S = (p = s.allpts).length;
        ((t = i - Gt(p[S - 6], p[S - 4], p[S - 2], 0.9)),
          (n = o - Gt(p[S - 5], p[S - 3], p[S - 1], 0.9)));
      } else ((t = i - g), (n = o - v));
      s.tgtArrowAngle = Yt(t, n);
    },
  };
gc.getArrowWidth = gc.getArrowHeight = function (e, t) {
  var n = (this.arrowWidthCache = this.arrowWidthCache || {}),
    r = n[e + ", " + t];
  return (
    r ||
    ((r = Math.max(Math.pow(13.37 * e, 0.9), 29) * t), (n[e + ", " + t] = r), r)
  );
};
var vc,
  yc,
  ...
  Lc = function (e, t, n, r, a) {
    ...
    if (
      ...
      Nc(t, n, Ic),
      (mc = Rc.nx * Ic.ny - Rc.ny * Ic.nx),
      (bc = Rc.nx * Ic.nx - Rc.ny * -Ic.ny),
      (Ec = Math.asin(Math.max(-1, Math.min(1, mc)))),
      Math.abs(Ec) < 1e-6)
    )
      return ((vc = t.x), (yc = t.y), void (Tc = Pc = 0));
    ((xc = 1),
      (wc = !1),
      bc < 0
        ? Ec < 0
          ? (Ec = Math.PI + Ec)
          : ((Ec = Math.PI - Ec), (xc = -1), (wc = !0))
        : Ec > 0 && ((xc = -1), (wc = !0)),
      (Pc = void 0 !== t.radius ? t.radius : r),
      (kc = Ec / 2),
      (Sc = Math.min(Rc.len / 2, Ic.len / 2)),
      a
        ? (Cc = Math.abs((Math.cos(kc) * Pc) / Math.sin(kc))) > Sc
          ? ((Cc = Sc), (Tc = Math.abs((Cc * Math.sin(kc)) / Math.cos(kc))))
          : (Tc = Pc)
        : ((Cc = Math.min(Sc, Pc)),
          (Tc = Math.abs((Cc * Math.sin(kc)) / Math.cos(kc)))),
      (_c = t.x + Ic.nx * Cc),
      (Ac = t.y + Ic.ny * Cc),
      (vc = _c - Ic.ny * Tc * xc),
      (yc = Ac + Ic.nx * Tc * xc),
    ...
    : (Lc(e, t, n, r, a),
      {
        ...
        stopX: _c,
        stopY: Ac,
        startAngle: Rc.ang + (Math.PI / 2) * xc,
        endAngle: Ic.ang - (Math.PI / 2) * xc,
        counterClockwise: wc,
      });
}
var Vc = 0.01,
...
((Xc.findMidptPtsEtc = function (e, t) {
  var n,
    r = t.posPts,
    a = t.intersectionPts,
  ...
  switch (e.pstyle("edge-distances").value) {
    ...
    case "endpoints":
      if (u) {
        var c = i(this.manualEndptToPx(e.source()[0], s), 2),
          d = c[0],
          h = c[1],
          f = i(this.manualEndptToPx(e.target()[0], l), 2),
          p = f[0],
          g = f[1],
          v = { x1: d, y1: h, x2: p, y2: g };
        ((o = (function (e, t, n, r) {
          var a = r - t,
            i = n - e,
            o = Math.sqrt(i * i + a * a);
  ...
  (Xc.findHaystackPoints = function (e) {
    for (var t = 0; t < e.length; t++) {
      var n = e[t],
        r = n._private,
        a = r.rscratch;
  ...
  (Xc.findSegmentsPoints = function (e, t) {
    ...
    for (var c = 0; c < s; c++) {
      var d = r.pfValue[c],
        ...
        m = { x: v.x1 * f + v.x2 * p, y: v.y1 * f + v.y2 * p };
  ...
  (Xc.findLoopPoints = function (e, t, n, r) {
  ...
  (Xc.findCompoundLoopPoints = function (e, t, n, r) {
    var a = e._private.rscratch;
    a.edgeType = "compound";
    var i = t.srcPos,
      o = t.tgtPos,
    ...
    var v = { x: i.x - s / 2, y: i.y - l / 2 },
      ...
      b = Math.max(0.5, Math.log(s * Vc)),
      x = Math.max(0.5, Math.log(u * Vc));
    a.ctrlpts = [
      m.x,
      m.y - (1 + Math.pow(50, 1.12) / 100) * g * (p / 3 + 1) * b,
      m.x - (1 + Math.pow(50, 1.12) / 100) * g * (p / 3 + 1) * x,
      m.y,
    ];
  }),
  (Xc.findStraightEdgePoints = function (e) {
    e._private.rscratch.edgeType = "straight";
  }),
  (Xc.findBezierPoints = function (e, t, n, r, a) {
    ...
    for (var f = 0; f < u; f++) {
      ...
      var y = void 0 !== (g = r ? c : void 0 !== c ? v * c : void 0) ? g : p,
        m = 1 - d,
        b = d,
  ...
  (Xc.findTaxiPoints = function (e, t) {
    var n = e._private.rscratch;
    n.edgeType = "segments";
    var r = "vertical",
      a = "horizontal",
  ...
  (Xc.tryToCorrectInvalidPoints = function (e, t) {
    var n = e._private.rscratch;
    if ("bezier" === n.edgeType) {
      var r = t.srcPos,
        ...
        f = t.srcRs,
        p = t.tgtRs,
        g = !G(n.startX) || !G(n.startY),
        v = !G(n.arrowStartX) || !G(n.arrowStartY),
        y = !G(n.endX) || !G(n.endY),
        m = !G(n.arrowEndX) || !G(n.arrowEndY),
        b =
          3 *
          (this.getArrowWidth(
            e.pstyle("width").pfValue,
        ...
        w = x < b,
        E = Ut({ x: n.ctrlpts[0], y: n.ctrlpts[1] }, { x: n.endX, y: n.endY }),
        k = E < b,
        T = !1;
      if (g || v || w) {
        T = !0;
      ...
      (t.allpts.push(t.endX, t.endY),
        (t.ctrlpts.length / 2) % 2 == 0
          ...
          : ((r = t.allpts.length / 2 - 3),
            (t.midX = Gt(t.allpts[r], t.allpts[r + 2], t.allpts[r + 4], 0.5)),
            (t.midY = Gt(
              t.allpts[r + 1],
              t.allpts[r + 3],
              t.allpts[r + 5],
  ...
  (Xc.checkForInvalidEdgeWarning = function (e) {
    var t = e[0]._private.rscratch;
    t.nodesOverlap || (G(t.startX) && G(t.startY) && G(t.endX) && G(t.endY))
      ? (t.loggedErr = !1)
      : t.loggedErr ||
        ((t.loggedErr = !0),
        rt(
  ...
  (Xc.findEdgeControlPoints = function (e) {
    var t = this;
    if (e && 0 !== e.length) {
      for (
        var n = this,
        ...
        if (!c.removed() && c.takesUpSpace())
          if ("haystack" !== h) {
            ...
            (null == b &&
              ((b = { eles: [] }),
              s.push({ pairId: y, edgeIsUnbundled: f }),
              a.set(m, b)),
              b.eles.push(c),
              f && (b.hasUnbundled = !0),
              p && (b.hasBezier = !0));
        ...
        var x = function () {
            ...
            for (var _ = 0; _ < d.eles.length; _++) {
              ...
              if (
                ...
                var L = T.intersectLine(y.x, y.y, b, x, m.x, m.y, 0, P, D),
                  z = (d.srcIntn = L),
                  ...
                  q = Math.sqrt(Y * Y + j * j);
                (G(q) && q >= Fc) ||
                  (q = Math.sqrt(Math.max(Y * Y, Vc) + Math.max(j * j, Vc)));
  ...
  (Xc.getSegmentPoints = function (e) {
    var t = e[0]._private.rscratch;
    if ((this.recalculateRenderedStyle(e), "segments" === t.edgeType))
      return jc(t.segpts);
  }),
  (Xc.getControlPoints = function (e) {
    var t = e[0]._private.rscratch;
...
var Yc = {
    ...
    findEndpoints: function (e) {
      var t,
        ...
        f = d.position(),
        p = h.position(),
        g = e.pstyle("target-arrow-shape").value,
        v = e.pstyle("source-arrow-shape").value,
      ...
      if (P) {
        ...
        ((o = S
          ? [E.ctrlpts[E.ctrlpts.length - 2], E.ctrlpts[E.ctrlpts.length - 1]]
          : F),
          (s = F));
      } else if (B) {
      ...
      if ("inside-to-node" === L) i = [p.x, p.y];
        ...
        ("outside-to-node" === L || "outside-to-node-or-label" === L
          ? (l = o)
          : ("outside-to-line" !== L && "outside-to-line-or-label" !== L) ||
            (l = [f.x, f.y]),
        ...
        "outside-to-node-or-label" === L || "outside-to-line-or-label" === L)
      ) {
        var j = h._private.rscratch,
          ...
          H = Y / 2,
          K = q / 2,
          Z = h.pstyle("text-valign").value;
        "top" === (Z = Cs(Z)) ? (U -= K) : "bottom" === Z && (U += K);
        var $ = h.pstyle("text-halign").value;
        "left" === ($ = Ts($)) ? (W -= H) : "right" === $ && (W += H);
        var Q = Tn(
          l[0],
          l[1],
        ...
        if (Q.length > 0) {
          var J = f,
            ...
            te = Ht(J, jt(Q)),
            ne = ee;
          if ((te < ee && ((i = Q), (ne = te)), Q.length > 2))
            Ht(J, { x: Q[2], y: Q[3] }) < ne && (i = [Q[2], Q[3]]);
        }
      }
      var re = Cn(i, o, c.arrowShapes[g].spacing(e) + y),
        ae = Cn(i, o, c.arrowShapes[g].gap(e) + y);
      if (
        ((E.endX = ae[0]),
        (E.endY = ae[1]),
        (E.arrowEndX = re[0]),
        ...
        ("outside-to-node" === R || "outside-to-node-or-label" === R
          ? (u = s)
          : ("outside-to-line" !== R && "outside-to-line-or-label" !== R) ||
            (u = [p.x, p.y]),
        ...
        "top" === (fe = Cs(fe)) ? (ce -= he) : "bottom" === fe && (ce += he);
        var pe = d.pstyle("text-halign").value;
        "left" === (pe = Ts(pe)) ? (le -= de) : "right" === pe && (le += de);
        var ge = Tn(
          u[0],
          u[1],
          [
        ...
        if (ge.length > 0) {
          var ve = p,
            ...
            me = Ht(ve, jt(ge)),
            be = ye;
          if ((me < ye && ((i = [ge[0], ge[1]]), (be = me)), ge.length > 2))
            Ht(ve, { x: ge[2], y: ge[3] }) < be && (i = [ge[2], ge[3]]);
        }
      }
      var xe = Cn(i, s, c.arrowShapes[v].spacing(e) + m),
        we = Cn(i, s, c.arrowShapes[v].gap(e) + m);
      ((E.startX = we[0]),
        (E.startY = we[1]),
        (E.arrowStartX = xe[0]),
        (E.arrowStartY = xe[1]),
        _ &&
          (G(E.startX) && G(E.startY) && G(E.endX) && G(E.endY)
            ? (E.badLine = !1)
            : (E.badLine = !0)));
    },
...
((qc.storeEdgeProjections = function (e) {
  var t = e._private,
    n = t.rscratch,
    r = n.edgeType;
  if (
    ...
    for (var a = 0; a + 5 < n.allpts.length; a += 4)
      Wc(this, e, n.allpts.slice(a, a + 6));
  } else if ("segments" === r) {
  ...
  (qc.recalculateEdgeProjections = function (e) {
...
((Uc.recalculateEdgeLabelProjections = function (e) {
  var t,
    n = e._private,
    r = n.rscratch,
    a = this,
  ...
  if (i.mid || i.source || i.target) {
    ...
    var o = function (e, t, r) {
      (ht(n.rscratch, e, t, r), ht(n.rstyle, e, t, r));
    };
    (o("labelX", null, t.x), o("labelY", null, t.y));
    var s = Hc(r.midDispX, r.midDispY);
    ...
    var l = function () {
      ...
      u = function (n) {
        ...
        if (i[n]) {
          ...
          switch (r.edgeType) {
            ...
            case "multibezier":
              for (var c, d = l(), h = 0, f = 0, p = 0; p < d.length; p++) {
                for (
                  var g = d[s ? p : d.length - 1 - p], v = 0;
                  v < g.segments.length;
                  v++
                ) {
                  var y = g.segments[s ? v : g.segments.length - 1 - v],
                    m = p === d.length - 1 && v === g.segments.length - 1;
            ...
            case "haystack":
              for (
                ...
                (s
                  ...
                  : ((P = { x: r.allpts[D - 2 - _], y: r.allpts[D - 1 - _] }),
                    (S = { x: r.allpts[D - 4 - _], y: r.allpts[D - 3 - _] })),
                (C = B),
                !((B += T = Ut(P, S)) >= u));
                _ += 2
              );
          ...
          (o("labelX", n, t.x), o("labelY", n, t.y), o("labelAutoAngle", n, a));
        }
      };
    (u("source"), u("target"), this.applyLabelDimensions(e));
  }
}),
  (Uc.applyLabelDimensions = function (e) {
    (this.applyPrefixedLabelDimensions(e),
      e.isEdge() &&
        (this.applyPrefixedLabelDimensions(e, "source"),
        this.applyPrefixedLabelDimensions(e, "target")));
  }),
  (Uc.applyPrefixedLabelDimensions = function (e, t) {
    var n = e._private,
      r = this.getLabelText(e, t),
      a = Ye(r, e._private.labelDimsKey);
    if (dt(n.rscratch, "prefixedLabelDimsKey", t) !== a) {
      ...
      var i = this.calculateLabelDimensions(e, r),
        ...
        u = dt(n.rscratch, "labelWrapCachedLines", t) || [],
        c = "wrap" !== l ? 1 : Math.max(u.length, 1),
        d = s * o,
        h = i.width,
        f = i.height + (c - 1) * (o - 1) * s;
      (ht(n.rstyle, "labelWidth", t, h),
        ht(n.rscratch, "labelWidth", t, h),
        ht(n.rstyle, "labelHeight", t, f),
        ht(n.rscratch, "labelHeight", t, f),
        ht(n.rscratch, "labelLineHeight", t, d),
        ht(n.rscratch, "labelActualDescent", t, i.labelActualDescent));
    }
  }),
  (Uc.getLabelText = function (e, t) {
    var n = e._private,
      a = t ? t + "-" : "",
      i = e.pstyle(a + "label").strValue,
      o = e.pstyle("text-transform").value,
      s = function (e, r) {
        return r ? (ht(n.rscratch, e, t, r), r) : dt(n.rscratch, e, t);
      };
    if (!i) return "";
    "none" == o ||
      ("uppercase" == o
    ...
    if ("wrap" === l) {
      ...
      (s("labelWrapCachedLines", f),
        (i = s("labelWrapCachedText", f.join("\n"))),
        s("labelWrapKey", u));
    } else if ("ellipsis" === l) {
      var S = e.pstyle("text-max-width").pfValue,
        B = "",
        D = !1;
      if (this.calculateLabelDimensions(e, i).width < S) return i;
      for (var _ = 0; _ < i.length; _++) {
        if (this.calculateLabelDimensions(e, B + i[_] + "…").width > S) break;
        ((B += i[_]), _ === i.length - 1 && (D = !0));
      }
      return (D || (B += "…"), B);
    }
    return i;
  }),
  (Uc.getLabelJustification = function (e) {
  ...
  (Uc.calculateLabelDimensions = function (e, t) {
    ...
    u.font = "".concat(r, " ").concat(o, " ").concat(a, "px ").concat(i);
    for (
      var d = 0, h = 0, f = t.split("\n"), p = f.length, g = 0, v = 0, y = 0;
      y < p;
      y++
    ) {
      var m = f[y],
        ...
        w = a;
      ("glyph" === s &&
        (0 === y && (v = b.actualBoundingBoxAscent),
  ...
  (Uc.calculateLabelAngle = function (e, t) {
    var n = e._private.rscratch,
      r = e.isEdge(),
      a = t ? t + "-" : "",
  ...
  (Uc.calculateLabelAngles = function (e) {
    var t = this,
      n = e.isEdge(),
...
var $c = {
  ...
  Jc = {};
[pc, gc, Xc, Yc, qc, Uc, Gc, $c, Qc].forEach(function (e) {
  ve(Jc, e);
});
var ed = {
  ...
  td = function (e, t) {
    var n = e[0];
    n &&
      n._private.grabbed !== t &&
      ((n._private.grabbed = t), e.updateStyle(!1));
  },
  nd = {
...
((nd.binder = function (e) {
  ...
  (nd.nodeIsDraggable = function (e) {
    return e && e.isNode() && !e.locked() && e.grabbable();
  }),
  (nd.nodeIsGrabbable = function (e) {
  ...
  (nd.load = function () {
      ...
      function (t) {
        if (m(t) && (1 !== e.hoverData.which || 1 === t.which)) {
          ...
          if (3 == t.which) {
            ...
            (d ? (d.activate(), d.emit(g), (e.hoverData.down = d)) : n.emit(g),
        ...
        if (e.hoverData.capture || m(t)) {
          ...
          if (f) {
            var E = l[0] - f[0],
              ...
              T = l[1] - f[1],
              C = k + T * T;
            e.hoverData.isOverThresholdDrag = v = C >= e.desktopTapThreshold2;
          }
          var P = a(t);
          ...
          if (3 === e.hoverData.which) {
            ...
            if (((n = !0), o.panningEnabled() && o.userPanningEnabled())) {
              ...
              (o.panBy(_), o.emit(S("dragpan")), (e.hoverData.dragged = !0));
            }
            ...
            if (
              ...
              if (v) {
                if (o.boxSelectionEnabled() && P)
                  ...
                  var R = { x: 0, y: 0 };
                  if (G(x[0]) && G(x[1]) && ((R.x += x[0]), (R.y += x[1]), M)) {
                    var I = e.hoverData.dragDelta;
                    I && G(I[0]) && G(I[1]) && ((R.x += I[0]), (R.y += I[1]));
                  }
          ...
          if (
            ...
            if (3 === e.hoverData.which) {
              ...
              if (
                ...
                var v = i.collection(e.getAllInBox(s[0], s[1], s[2], s[3]));
                (e.redrawHint("select", !0),
                  v.length > 0 && e.redrawHint("eles", !0),
                  i.emit(f("boxend")));
                var y = function (e) {
                ...
                ("additive" === i.selectionType() ||
                  h ||
                  i.$(n).unmerge(v).unselect(),
                  v.emit(f("box")).stdFilter(y).select().emit(f("boxselect")),
                  e.redraw());
              }
              if (
                (e.hoverData.dragging &&
          ...
          if (!e.scrollingPage) {
            ...
            if (
              ...
              (t.preventDefault(),
                ...
                n && Math.abs(r) > 5 && (r = 5 * Wt(r)),
                (h = r / -250),
                k && ((h /= O), (h *= 3)),
                (h *= e.wheelSensitivity),
                1 === t.deltaMode && (h *= 33));
              var f = s.zoom() * Math.pow(10, h);
              ("gesturechange" === t.type && (f = e.gestureStartZoom * t.scale),
                s.zoom({ level: f, renderedPosition: { x: d[0], y: d[1] } }),
                s.emit({
                  type: "gesturechange" === t.type ? "pinchzoom" : "scrollzoom",
                  originalEvent: t,
                  position: { x: c[0], y: c[1] },
                }));
            }
    ...
    if (
          ...
          if (((e.hasTouchStarted = !0), m(t))) {
            ...
            if (t.touches[1]) {
              ...
              ((B = H(T, C, P, S)),
                (D = K(T, C, P, S)),
                (A = [
                  ((_ = [(T + P) / 2, (C + S) / 2])[0] - p.x) / g,
                  (_[1] - p.y) / g,
                ]));
              if (D < 4e4 && !t.touches[2]) {
                var v = e.findNearestElement(a[0], a[1], !0, !0),
                  y = e.findNearestElement(a[2], a[3], !0, !0);
                return (
                  v && v.isNode()
                    ? (v.activate().emit(l("cxttapstart")),
                      (e.touchData.start = v))
                    : y && y.isNode()
              ...
              (r(x, ["touchstart", "tapstart", "vmousedown"], t, {
                ...
                (e.touchData.tapholdTimeout = setTimeout(function () {
                  !1 !== e.touchData.singleTouchMoved ||
                    ...
                    r(e.touchData.start, ["taphold"], t, { x: a[0], y: a[1] });
                }, e.tapholdDuration)));
            }
      ...
      e.registerBinding(
        ...
        (X = function (t) {
          ...
          if (n || m(t)) {
            ...
            if (n && t.touches[0] && g) {
              for (var v = [], y = 0; y < s.length; y++) v[y] = s[y] - l[y];
              var b = t.touches[0].clientX - g[0],
                x = b * b,
                w = t.touches[0].clientY - g[1];
            ...
            if (n && e.touchData.cxt) {
              ...
              if (L) {
                ...
                (o.viewport({ zoom: Z, pan: ee, cancelOnFailedZoom: !0 }),
                  o.emit(p("pinchzoom")),
                  (B = j),
                  (T = E),
                  (C = k),
              ...
              if (
                ...
                if (f) {
                  ...
                  (ae && u(te, { inDragLayer: !0 }), (e.dragData.didDrag = !0));
                  var ie = { x: 0, y: 0 };
                  if (G(v[0]) && G(v[1]))
                    if (((ie.x += v[0]), (ie.y += v[1]), ae))
                      (e.redrawHint("eles", !0),
                        (oe = e.touchData.dragDelta) &&
                          ...
                          ((ie.x += oe[0]), (ie.y += oe[1])));
                  ((e.hoverData.draggingEles = !0),
                    te.silentShift(ie).emit(p("position")).emit(p("drag")),
                    e.redrawHint("drag", !0),
                  ...
                  var oe;
                  0 ===
                  (oe = e.touchData.dragDelta = e.touchData.dragDelta || [])
                    .length
                    ? (oe.push(v[0]), oe.push(v[1]))
                    : ((oe[0] += v[0]), (oe[1] += v[1]));
                }
              if (
              ...
              if (
                ...
                i(ne, e.touchData.starts) &&
                  (t.preventDefault(),
                  e.data.bgActivePosistion ||
                    (e.data.bgActivePosistion = jt(e.touchData.startPosition)),
                  e.swipePanning
                    ? (o.panBy({ x: v[0] * c, y: v[1] * c }),
                      o.emit(p("dragpan")))
                    : f &&
                      ((e.swipePanning = !0),
                      o.panBy({ x: b * c, y: w * c }),
              ...
              if (null != a) {
                ...
                (d(v),
                  ...
                  y &&
                    ...
                    v.emit(f("free")),
                    e.dragData.didDrag &&
                      (a.emit(f("dragfreeon")), v.emit(f("dragfree")))),
                  r(a, ["touchend", "tapend", "vmouseup", "tapdragout"], t, {
                    x: l[0],
                    y: l[1],
                  }),
                  a.unactivate(),
                ...
                r(m, ["touchend", "tapend", "vmouseup", "tapdragout"], t, {
                  x: l[0],
                  y: l[1],
                });
              }
              ...
              (e.touchData.singleTouchMoved ||
                ...
                t.timeStamp - U <= o.multiClickDebounceTime()
                  ? (W && clearTimeout(W),
                    (q = !0),
                    (U = null),
                    r(a, ["dbltap", "vdblclick"], t, { x: l[0], y: l[1] }))
                  : ((W = setTimeout(function () {
                      q ||
                        r(a, ["onetap", "voneclick"], t, { x: l[0], y: l[1] });
      ...
      var Z = [],
        ...
        J = function (e) {
          for (var t = 0; t < Z.length; t++) {
            if (Z[t].event.pointerId === e.pointerId)
              return void Z.splice(t, 1);
          }
        },
        ee = function (e) {
      ...
      (e.registerBinding(e.container, "pointerdown", function (e) {
        te(e) || (e.preventDefault(), Q(e), ee(e), F(e));
      }),
  ...
  generatePolygon: function (e, t) {
    return (this.nodeShapes[e] = {
      ...
      intersectLine: function (e, t, n, r, a, i, o, s) {
        return Tn(a, i, this.points, e, t, n / 2, r / 2, o);
      },
      checkPoint: function (e, t, n, r, a, i, o, s) {
        return vn(e, t, this.points, i, o, r, a, [0, -1], n);
      },
      hasMiterBounds: "rectangle" !== e,
      miterBounds: function (e, t, n, r, a, i) {
        return un(this.points, e, t, n, r, a);
      },
    });
  },
};
((rd.generateEllipse = function () {
  ...
  (rd.generateRoundPolygon = function (e, t) {
    return (this.nodeShapes[e] = {
      renderer: this,
      name: e,
      points: t,
        ...
        return (function (e, t, n, r, a, i, o, s, l) {
          ...
          l.forEach(function (n, i) {
            (0 === i
              ...
              (d[4 * i] = n.stopX),
              (d[4 * i + 1] = n.stopY),
              0 !== (u = xn(e, t, r, a, n.cx, n.cy, n.radius)).length &&
                c.push(u[0], u[1]));
          });
  ...
  (rd.generateRoundRectangle = function () {
      ...
      this.nodeShapes.roundrectangle =
        {
          ...
          checkPoint: function (e, t, n, r, a, i, o, s) {
            ...
            return (
              !!vn(e, t, this.points, i, o, r, a - c, [0, -1], n) ||
              !!vn(e, t, this.points, i, o, r - c, a, [0, -1], n) ||
              !!bn(e, t, c, c, i - l + s, o - u + s, n) ||
              !!bn(e, t, c, c, i + l - s, o - u + s, n) ||
              !!bn(e, t, c, c, i + l - s, o + u - s, n) ||
              !!bn(e, t, c, c, i - l + s, o + u - s, n)
            );
  ...
  (rd.generateCutRectangle = function () {
    return (this.nodeShapes["cut-rectangle"] = this.nodeShapes.cutrectangle =
      {
        ...
        checkPoint: function (e, t, n, r, a, i, o, s) {
          ...
          if (vn(e, t, this.points, i, o, r, a - 2 * l, [0, -1], n)) return !0;
          if (vn(e, t, this.points, i, o, r - 2 * l, a, [0, -1], n)) return !0;
          var u = this.generateCutTrianglePts(r, a, i, o);
          return (
            gn(e, t, u.topLeft) ||
            gn(e, t, u.topRight) ||
            gn(e, t, u.bottomRight) ||
            gn(e, t, u.bottomLeft)
          );
        },
      });
  }),
  (rd.generateBarrel = function () {
    return (this.nodeShapes.barrel = {
      ...
      checkPoint: function (e, t, n, r, a, i, o, s) {
        var l = An(r, a),
          u = l.heightOffset,
          c = l.widthOffset;
        if (vn(e, t, this.points, i, o, r, a - 2 * u, [0, -1], n)) return !0;
        if (vn(e, t, this.points, i, o, r - 2 * c, a, [0, -1], n)) return !0;
        for (
  ...
  (rd.generateBottomRoundrectangle = function () {
      ...
      this.nodeShapes.bottomroundrectangle =
        {
          ...
          intersectLine: function (e, t, n, r, a, i, o, s) {
            var l = t - (r / 2 + o),
              u = En(a, i, e, t, e - (n / 2 + o), l, e + (n / 2 + o), l, !1);
            return u.length > 0 ? u : cn(a, i, e, t, n, r, o, s);
          },
          checkPoint: function (e, t, n, r, a, i, o, s) {
            var l = 2 * (s = "auto" === s ? Dn(r, a) : s);
            if (vn(e, t, this.points, i, o, r, a - l, [0, -1], n)) return !0;
            if (vn(e, t, this.points, i, o, r - l, a, [0, -1], n)) return !0;
            var u = r / 2 + 2 * n,
              c = a / 2 + 2 * n;
            return (
              !!gn(e, t, [i - u, o - c, i - u, o, i + u, o, i + u, o - c]) ||
              !!bn(e, t, l, l, i + r / 2 - s, o + a / 2 - s, n) ||
              !!bn(e, t, l, l, i - r / 2 + s, o + a / 2 - s, n)
            );
          },
        });
  }),
  (rd.registerNodeShapes = function () {
    var e = (this.nodeShapes = {}),
      t = this;
    (this.generateEllipse(),
      this.generatePolygon("triangle", Pn(3, 0)),
      this.generateRoundPolygon("round-triangle", Pn(3, 0)),
      this.generatePolygon("rectangle", Pn(4, 0)),
    ...
    (this.generatePolygon("diamond", n),
      ...
      this.generatePolygon("pentagon", Pn(5, 0)),
      this.generateRoundPolygon("round-pentagon", Pn(5, 0)),
      this.generatePolygon("hexagon", Pn(6, 0)),
      this.generateRoundPolygon("round-hexagon", Pn(6, 0)),
      this.generatePolygon("heptagon", Pn(7, 0)),
      this.generateRoundPolygon("round-heptagon", Pn(7, 0)),
      this.generatePolygon("octagon", Pn(8, 0)),
      this.generateRoundPolygon("round-octagon", Pn(8, 0)));
    var r = new Array(20),
      a = Bn(5, 0),
      i = Bn(5, Math.PI / 5),
      o = 0.5 * (3 - Math.sqrt(5));
...
var ad = {
    ...
    beforeRender: function (e, t) {
      if (!this.destroyed) {
        null == t && tt("Priority is not optional for beforeRender");
    ...
    var n = function (r) {
      if (!e.destroyed) {
        if (t.batching());
          ...
          var i = (e.lastDrawTime = Ie());
          (void 0 === e.averageRedrawTime && (e.averageRedrawTime = i - a),
...
((sd.clientFunctions = [
  ...
  (sd.init = function (e) {
    ...
    ((t.selection = [void 0, void 0, void 0, void 0, 0]),
      ...
      (t.forcedPixelRatio = G(e.pixelRatio) ? e.pixelRatio : null),
  ...
  (sd.isHeadless = function () {
    return !1;
  }),
  [fc, Jc, ed, nd, rd, ad].forEach(function (e) {
    ve(sd, e);
  }));
var ld = 1e3 / 60,
  ud = function (e) {
      ...
      if (!t.dequeueingSetup) {
        ...
        n.beforeRender(function (a, i) {
          ...
          for (a || n.flushRenderedStyleQueue(); ;) {
            ...
            } else if (p >= e.deqNoDrawCost * ld) break;
            var v = e.deq(t, d, c);
            if (!(v.length > 0)) break;
      ...
      [
        {
          key: "getIdsFor",
          value: function (e) {
            null == e && tt("Can not get id list for null key");
            var t = this.idsByKey,
              n = this.idsByKey.get(e);
            return (n || ((n = new gt()), t.set(e, n)), n);
          },
        },
        {
          key: "addIdForKey",
        ...
        },
        {
          ...
          value: function (e) {
            var t = this.cachesByLvl,
              n = this.lvls,
              r = t.get(e);
            return (r || ((r = new ft()), t.set(e, r), n.push(e)), r);
          },
        },
        {
          key: "getCache",
  ...
  pd = function (e, t) {
    ...
    var r = fd(t);
    (ve(n, r),
      (n.lookup = new cd(r.getKey, r.doesEleInvalidateKey)),
      n.setupDequeueing());
  },
  gd = pd.prototype;
((gd.reasons = hd),
  (gd.getTextureQueue = function (e) {
    var t = this;
    return (
  ...
  (gd.getRetiredTextureQueue = function (e) {
    var t = (this.eleImgCaches.retired = this.eleImgCaches.retired || {});
    return (t[e] = t[e] || []);
  }),
  (gd.getElementQueue = function () {
  ...
  (gd.getElementKeyToQueue = function () {
    return (this.eleKeyToCacheQueue = this.eleKeyToCacheQueue || {});
  }),
  (gd.getElement = function (e, t, n, r, a) {
    var i = this,
      o = this.renderer,
      s = o.cy.zoom(),
      l = this.lookup;
    ...
    if (
      ...
      return null;
    if ((null == r && (r = Math.ceil(qt(s * n))), r < -4)) r = -4;
    ...
    if (
      ...
      v.context.clearRect(v.usedWidth, 0, d, f),
      b(C))
    )
      P();
    else if (b(m)) {
      ...
      for (var S = m.level; S > r; S--)
        C = i.getElement(e, t, n, S, hd.downscale);
      P();
    } else {
      var B;
      if (!x && !w && !E)
  ...
  (gd.invalidateElements = function (e) {
    for (var t = 0; t < e.length; t++) this.invalidateElement(e[t]);
  }),
  (gd.invalidateElement = function (e) {
    var t = this,
      n = t.lookup,
      r = [];
    if (n.isInvalid(e)) {
  ...
  (gd.retireTexture = function (e) {
    ...
    (ct(a), this.getRetiredTextureQueue(t).push(e));
  }),
  (gd.addTexture = function (e, t) {
    var n = {};
    return (
  ...
  (gd.recycleTexture = function (e, t) {
    for (
  ...
  (gd.dequeue = function (e) {
    for (
      ...
      if (((r[l] = null), !c)) {
        ...
        t.getElement(u, d, e, s.level, hd.dequeue);
      }
    }
    return a;
  }),
  (gd.removeFromQueue = function (e) {
    ...
    null != a &&
      (1 === a.eles.length
        ? ((a.reqs = Ze), t.updateItem(a), t.pop(), (n[r] = null))
        : a.eles.unmerge(e));
  }),
  (gd.onDequeue = function (e) {
    this.onDequeues.push(e);
  }),
  (gd.offDequeue = function (e) {
    ut(this.onDequeues, e);
  }),
  (gd.setupDequeueing = ud({
...
var vd = function (e) {
    ...
    ((t.layersByLevel = {}),
      ...
      (t.scheduleElementRefinement = De(function () {
    ...
    ((t.layersQueue = new Pt(function (e, t) {
      return t.reqs - e.reqs;
    })),
      t.setupDequeueing());
  },
...
((yd.makeLayer = function (e, t) {
  ...
  (yd.getLayers = function (e, t, n) {
    var r = this,
      a = r.renderer.cy.zoom(),
      i = r.firstGet;
    if (((r.firstGet = !1), null == n))
      if ((n = Math.ceil(qt(a * t))) < -4) n = -4;
    ...
    for (var h = null, f = e.length / 1, p = !i, g = 0; g < e.length; g++) {
      var v = e[g],
      ...
      if (b) h = b;
        ...
        if (
          (!h || h.eles.length >= f || !sn(h.bb, v.boundingBox())) &&
          !(h = d({ insert: !0, after: h }))
        )
          return null;
        (s || p ? r.queueLayer(h, v) : r.drawEleInLayer(h, v, n, t),
          h.eles.push(v),
          (m[n] = h));
      }
    }
  ...
  (yd.getEleLevelForLayerLevel = function (e, t) {
    return e;
  }),
  (yd.drawEleInLayer = function (e, t, n, r) {
    var a = this.renderer,
      i = e.context,
      o = t.boundingBox();
    0 !== o.w &&
  ...
  (yd.levelIsComplete = function (e, t) {
  ...
  (yd.validateLayersElesOrdering = function (e, t) {
    var n = this.layersByLevel[e];
    if (n)
      for (var r = 0; r < n.length; r++) {
  ...
  (yd.updateElementsInLayers = function (e, t) {
    for (var n = Q(e[0]), r = 0; r < e.length; r++)
      for (
        var a = n ? null : e[r],
          i = n ? e[r] : e[r].ele,
  ...
  (yd.invalidateElements = function (e) {
    var t = this;
    0 !== e.length &&
  ...
  (yd.refineElementTextures = function (e) {
    var t = this;
    t.updateElementsInLayers(e, function (e, n, r) {
      var a = e.replacement;
      if (
        (a ||
          (((a = e.replacement = t.makeLayer(e.bb, e.level)).replaces = e),
          (a.eles = e.eles)),
        !a.reqs)
      )
        for (var i = 0; i < a.eles.length; i++) t.queueLayer(a, a.eles[i]);
    });
  }),
  (yd.enqueueElementRefinement = function (e) {
    (this.eleTxrDeqs.merge(e), this.scheduleElementRefinement());
  }),
  (yd.queueLayer = function (e, t) {
  ...
  (yd.applyLayerReplacement = function (e) {
  ...
  (yd.requestRedraw = De(function () {
    var e = this.renderer;
    (e.redrawHint("eles", !0), e.redrawHint("drag", !0), e.redraw());
  }, 100)),
  (yd.setupDequeueing = ud({
...
wd.arrowShapeImpl = function (e) {
  return (xd ||
    (xd = {
      polygon: Ed,
      "triangle-backcurve": kd,
      "triangle-tee": Td,
      "circle-triangle": Cd,
      "triangle-cross": Td,
      circle: Pd,
...
((Sd.drawCachedElement = function (e, t, n, r, a, i) {
  var o = this,
    s = o.data,
    l = s.eleTxrCache,
    u = s.lblTxrCache,
  ...
  if (0 !== h.w && 0 !== h.h && t.visible() && (!r || rn(h, r))) {
    var p = t.isEdge(),
      g = t.element()._private.rscratch.badLine;
    (o.drawElementUnderlay(e, t),
      o.drawCachedElementPortion(e, t, l, n, a, f, Bd, Md),
      (p && g) || o.drawCachedElementPortion(e, t, u, n, a, f, Dd, Rd),
      p &&
        !g &&
        (o.drawCachedElementPortion(e, t, c, n, a, f, _d, Rd),
        o.drawCachedElementPortion(e, t, d, n, a, f, Ad, Rd)),
      o.drawElementOverlay(e, t));
  }
}),
  (Sd.drawElements = function (e, t) {
    for (var n = 0; n < t.length; n++) {
      var r = t[n];
      this.drawElement(e, r);
    }
  }),
  (Sd.drawCachedElements = function (e, t, n, r) {
    for (var a = 0; a < t.length; a++) {
      var i = t[a];
      this.drawCachedElement(e, i, n, r);
    }
  }),
  (Sd.drawCachedNodes = function (e, t, n, r) {
    for (var a = 0; a < t.length; a++) {
      var i = t[a];
      i.isNode() && this.drawCachedElement(e, i, n, r);
    }
  }),
  (Sd.drawLayeredElements = function (e, t, n, r) {
...
((Id.drawEdgeOverlay = Nd("overlay")),
  (Id.drawEdgeUnderlay = Nd("underlay")),
  (Id.drawEdgePath = function (e, t, n, a) {
    var i,
    ...
    if (u) {
      var h = n.join("$");
      o.pathCacheKey && o.pathCacheKey === h
        ? ((i = t = o.pathCache), (l = !0))
        : ((i = t = new Path2D()), (o.pathCacheKey = h), (o.pathCache = i));
    }
    if (s.setLineDash)
      switch (a) {
        case "dotted":
    ...
    if (!l && !o.badLine)
      switch (
        (t.beginPath && t.beginPath(), t.moveTo(n[0], n[1]), o.edgeType)
      ) {
        case "bezier":
        case "self":
        case "compound":
  ...
  (Id.drawEdgeTrianglePath = function (e, t, n) {
  ...
  (Id.drawArrowheads = function (e, t, n) {
  ...
  (Id.drawArrowhead = function (e, t, n, r, a, i, o) {
    if (!(
      isNaN(r) ||
      null == r ||
      isNaN(a) ||
      ...
      if ("none" !== l) {
        var u =
            "hollow" === t.pstyle(n + "-arrow-fill").value ? "both" : "filled",
  ...
  (Id.drawArrowShape = function (e, t, n, r, a, i, o, s, l) {
    var u,
      c = this,
    ...
    (h ||
      ...
      d ? y.draw(t, 1, 0, { x: 0, y: 0 }, 1) : y.draw(t, v, l, p, r),
...
var Ld = {
    ...
    drawInscribedImage: function (e, t, n, r, a) {
      ...
      if (
        ...
        if ("contain" === d) ((C *= S = Math.min(v / C, y / P)), (P *= S));
        else if ("cover" === d) {
          var S;
          ((C *= S = Math.max(v / C, y / P)), (P *= S));
        }
        var B = s - v / 2,
        ...
        if (
          ...
          (b &&
            ...
            m.pathCache
              ? e.clip(m.pathCache)
              : (i.nodeShapes[i.getNodeShape(n)].draw(e, s, l, v, y, E, m),
                e.clip())),
...
((zd.eleTextBiggerThanMin = function (e, t) {
  if (!t) {
    var n = e.cy().zoom(),
  ...
  (zd.drawElementText = function (e, t, n, r, a) {
    ...
    if (t.isNode()) {
      ...
      if (c || ((!d || !d.value) && (!h || !h.value) && (!f || !f.value)))
        return;
    ...
    (n && ((p = n), e.translate(-p.x1, -p.y1)),
      null == a
        ? (o.drawText(e, t, null, g, i),
          t.isEdge() &&
            (o.drawText(e, t, "source", g, i),
            o.drawText(e, t, "target", g, i)))
        : o.drawText(e, t, a, g, i),
      n && e.translate(p.x1, p.y1));
  }),
  (zd.getFontCache = function (e) {
    var t;
  ...
  (zd.setupTextStyle = function (e, t) {
    var n = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2],
  ...
  (zd.getTextAngle = function (e, t) {
    var n,
      r = e._private.rscratch,
      a = t ? t + "-" : "",
      i = e.pstyle(a + "text-rotation");
    if ("autorotate" === i.strValue) {
      var o = dt(r, "labelAngle", t);
      n = e.isEdge() ? o : 0;
    } else n = "none" === i.strValue ? 0 : i.pfValue;
    return n;
  }),
  (zd.drawText = function (e, t, n) {
    ...
    if (!a || (0 !== o && 0 !== t.pstyle("text-opacity").value)) {
      ...
      if (null != d && "" !== d && !isNaN(u) && !isNaN(c)) {
        ...
        var h,
          f = n ? n + "-" : "",
          p = dt(i, "labelWidth", n),
          g = dt(i, "labelHeight", n),
          v = dt(i, "labelActualDescent", n),
        ...
        var T = t.pstyle("text-background-opacity").value,
          C = t.pstyle("text-border-opacity").value,
          P = t.pstyle("text-border-width").pfValue,
          S = t.pstyle("text-background-padding").pfValue,
          B = t.pstyle("text-background-shape").strValue,
          D = "round-rectangle" === B || "roundrectangle" === B,
          _ = "circle" === B;
        if (T > 0 || (P > 0 && C > 0)) {
          var A = e.fillStyle,
            M = e.strokeStyle,
          ...
          if (
            ...
            (e.beginPath(),
              D
                ? Od(e, V + Y, F + Y, X - 2 * Y, j - 2 * Y, 2)
                : e.rect(V + Y, F + Y, X - 2 * Y, j - 2 * Y),
              e.stroke());
          }
          ((e.fillStyle = A),
            (e.strokeStyle = M),
        ...
        if (
          ...
          var W = dt(i, "labelWrapCachedLines", n),
            U = dt(i, "labelLineHeight", n),
            H = p / 2,
        ...
        var Z = function () {
          ...
          ne = function () {
            if (L > 0) {
              ...
              if (g) s = W(h, f, i, p).path;
              if ("ellipse" === i) l.drawEllipsePath(s || e, n.x, n.y, h, f);
              else if (
                [
                  "round-diamond",
                  "round-heptagon",
              ...
              } else if (["roundrectangle", "round-rectangle"].includes(i))
                ((X = "auto" === X ? Dn(h, f) : X),
                ...
                ["bottomroundrectangle", "bottom-round-rectangle"].includes(i)
              )
                ((X = "auto" === X ? Dn(h, f) : X),
              ...
              else if ("barrel" === i) l.drawBarrelPath(s || e, n.x, n.y, h, f);
              else if (
              ...
              if ((g ? e.stroke(s) : e.stroke(), "double" === O)) {
                e.lineWidth = o / 3;
...
((Vd.drawNodeOverlay = Fd("overlay")),
  (Vd.drawNodeUnderlay = Fd("underlay")),
  (Vd.hasPie = function (e) {
    return (e = e[0])._private.hasPie;
  }),
  (Vd.hasStripe = function (e) {
    return (e = e[0])._private.hasStripe;
  }),
  (Vd.drawPie = function (e, t, n, r) {
    ...
    if (
      ...
      for (var g = 1; g <= i.pieBackgroundN; g++) {
        var v = t.pstyle("pie-" + g + "-background-size").value,
          y = t.pstyle("pie-" + g + "-background-color").value,
          m = t.pstyle("pie-" + g + "-background-opacity").value * n,
          b = v / 100;
        b + p > 1 && (b = 1 - p);
  ...
  (Vd.drawStripe = function (e, t, n, r) {
    ((t = t[0]), (r = r || t.position()));
    var a = t.cy().style(),
      i = r.x,
      o = r.y,
    ...
    for (var g = 1; g <= a.stripeBackgroundN; g++) {
      var v = t.pstyle("stripe-" + g + "-background-size").value,
        ...
        m = t.pstyle("stripe-" + g + "-background-opacity").value * n,
        b = v / 100;
      (b + u > 1 && (b = 1 - u),
        0 === v ||
          u >= 1 ||
...
function eh(e, t, n, r) {
  ...
  (e.bindBuffer(e.ARRAY_BUFFER, d),
    ...
    s === e.FLOAT
      ? e.vertexAttribPointer(r, o, s, !1, c, 0)
      : s === e.INT && e.vertexAttribIPointer(r, o, s, c, 0),
    e.vertexAttribDivisor(r, 1),
    e.bindBuffer(e.ARRAY_BUFFER, null));
  for (var h = new Array(t), f = 0; f < t; f++) h[f] = Jd(e, s, u, c, o, f);
  return (
    (d.dataArray = u),
    (d.stride = c),
    (d.size = o),
...
((jd.getPixelRatio = function () {
  ...
  (jd.paintCache = function (e) {
    for (
      var t, n = (this.paintCaches = this.paintCaches || []), r = !0, a = 0;
      a < n.length;
      a++
    )
      if ((t = n[a]).context === e) {
  ...
  (jd.createGradientStyleFor = function (e, t, n, r, a) {
    var i,
      o = this.usePaths(),
  ...
  (jd.gradientFillStyle = function (e, t, n, r) {
    var a = this.createGradientStyleFor(e, "background", t, n, r);
    if (!a) return null;
    e.fillStyle = a;
  }),
  (jd.colorFillStyle = function (e, t, n, r, a) {
    e.fillStyle = "rgba(" + t + "," + n + "," + r + "," + a + ")";
  }),
  (jd.eleFillStyle = function (e, t, n) {
  ...
  (jd.gradientStrokeStyle = function (e, t, n, r) {
    var a = this.createGradientStyleFor(e, "line", t, n, r);
    if (!a) return null;
    e.strokeStyle = a;
  }),
  (jd.colorStrokeStyle = function (e, t, n, r, a) {
    e.strokeStyle = "rgba(" + t + "," + n + "," + r + "," + a + ")";
  }),
  (jd.eleStrokeStyle = function (e, t, n) {
  ...
  (jd.render = function (e) {
    ...
    if ((this.drawSelectionRectangle(e, S), h && 1 !== f)) {
      ...
      ((c[t.NODE] || L[t.NODE]) && (j(O, V, L[t.NODE]), (c[t.NODE] = !1)),
        (c[t.DRAG] || L[t.DRAG]) && (j(F, X, L[t.DRAG]), (c[t.DRAG] = !1)));
    }
    ((t.prevViewport = k),
      t.clearingMotionBlur &&
  ...
  (jd.drawSelectionRectangle = function (e, t) {
    var n = this,
      r = n.cy,
      a = n.data,
      i = r.style(),
    ...
    if (n.showFps || (!o && l[n.SELECT_BOX] && !s)) {
      ...
      if (
        (t(c),
        1 == n.selection[4] && (n.hoverData.selecting || n.touchData.selecting))
      ) {
        var d = n.cy.zoom(),
      ...
      if (a.bgActivePosistion && !n.hoverData.selecting) {
        ...
        ((c.fillStyle =
          ...
          ")"),
          c.beginPath(),
          c.arc(f.x, f.y, i.core("active-bg-size").pfValue / d, 0, 2 * Math.PI),
          c.fill());
      }
      var p = n.lastRedrawTime;
      if (n.showFps && p) {
        p = Math.round(p);
        var g = Math.round(1e3 / p),
          v = "1 frame = " + p + " ms = " + g + " fps";
        if (
          ...
          Xd = y.actualBoundingBoxAscent;
        }
        c.fillText(v, 0, Xd);
        (c.strokeRect(0, Xd + 10, 250, 20),
          c.fillRect(0, Xd + 10, 250 * Math.min(g / 60, 1), 20));
      }
      s || (l[n.SELECT_BOX] = !1);
    }
  }));
var th = "undefined" != typeof Float32Array ? Float32Array : Array;
function nh() {
  var e = new th(9);
  return (
    th != Float32Array &&
    ...
    return n(
      function e(n, r, a, i) {
        (t(this, e),
          ...
          (this.canvas = i(n, r, r)),
          (this.scratch = i(n, r, this.texHeight, "scratch")));
      },
      [
        {
          key: "lock",
        ...
        },
        {
          ...
          value: function (e, t, n) {
                ...
                : this.enableWrapping
                  ? (function () {
                      ...
                      (t.context.drawImage(e, 0, 0, p, s, l, f, p, s),
                        (h[0] = { x: l, y: f, w: p, h: c }));
                      var g = n,
                        v = (r.freePointer.row + 1) * o,
                        y = i;
                      (t && t.context.drawImage(e, g, 0, y, s, 0, v, y, s),
                        (h[1] = { x: 0, y: v, w: y, h: c }),
                        (r.freePointer.x = i),
                        r.freePointer.row++);
                    })()
            ...
            return (this.keyToLocation.set(e, h), (this.needsBuffer = !0), h);
          },
        },
        {
          key: "getOffsets",
        ...
        },
        {
          ...
          value: function (e) {
            ...
            return (
              !(this.freePointer.x + r > t) || this.freePointer.row < n - 1
            );
          },
        },
        {
                ...
                var c = function () {
                  ...
                  try {
                    for (g.s(); !(p = g.n()).done;) {
                      var v = p.value;
                      if (!f.has(v)) {
                        var y = i(d.getOffsets(v), 2),
                          m = y[0],
                          b = y[1];
                        (l.canFit({ w: m.w + b.w, h: m.h }) ||
                          (l.lock(), (l = e._createAtlas()), a.push(l)),
                          d.canvas &&
                            (e._copyTextureToNewAtlas(v, d, l), s.set(v, l)));
                      }
                    }
                  } catch (e) {
                    g.e(e);
        ...
        },
        {
          ...
          value: function (e, t) {
            ...
            var r = this.collections.get(n),
              a = ve({ type: e, atlasCollection: r }, t);
        ...
        },
        {
          ...
          value: function (e, t) {
            ...
            return (Array.isArray(a) ? a : [a]).map(function (a) {
              var o = r.getBoundingBox(e, a),
                s = n.getOrCreateAtlas(e, t, o, a),
                l = i(s.getOffsets(a), 2),
                u = l[0];
              return { atlas: s, tex: u, tex1: u, tex2: l[1], bb: o };
            });
          },
        },
        {
            ...
            try {
              for (n.s(); !(e = n.n()).done;) {
                var a = i(e.value, 2),
                  ...
                  l = s.keyCount,
                  u = s.atlasCount;
                t.push({ type: o, keyCount: l, atlasCount: u });
              }
            } catch (e) {
              n.e(e);
            } finally {
    ...
    return n(
      function e(n, r, a) {
        (t(this, e),
          ...
          (this.batchDebugInfo = []),
          (a.enableWrapping = !0),
          (a.createTextureCanvas = qd),
          (this.atlasManager = new uh(n, a)),
          (this.batchManager = new ch(a)),
          (this.simpleShapeOptions = new Map()),
          (this.program = this._createShaderProgram(dh.SCREEN)),
          (this.pickingProgram = this._createShaderProgram(dh.PICKING)),
      ...
      [
        ...
        },
        {
          ...
          value: function (e) {
            var t = this.gl,
              ...
              i = (function (e, t, n) {
                var r = Yd(e, e.VERTEX_SHADER, t),
                  a = Yd(e, e.FRAGMENT_SHADER, n),
                  i = e.createProgram();
                if (
                  (e.attachShader(i, r),
                  e.attachShader(i, a),
            ...
            ((i.aPosition = t.getAttribLocation(i, "aPosition")),
              ...
              (i.uTextures = []));
            for (var o = 0; o < this.batchManager.getMaxAtlasesPerBatch(); o++)
              i.uTextures.push(t.getUniformLocation(i, "uTexture".concat(o)));
            return i;
          },
        },
        {
            ...
            return (
              ...
              (function (e, t, n, r) {
                ...
                (e.bindBuffer(e.ARRAY_BUFFER, u),
                  ...
                  s === e.FLOAT
                    ? e.vertexAttribPointer(n, o, s, !1, 0, 0)
                    : s === e.INT && e.vertexAttribIPointer(n, o, s, 0, 0),
                  e.enableVertexAttribArray(n),
                  e.bindBuffer(e.ARRAY_BUFFER, null));
              })(n, "vec2", r.aPosition, e),
              (this.transformBuffer = (function (e, t, n) {
                for (
                  var r = new Float32Array(9 * t), a = new Array(t), i = 0;
                  i < t;
                  i++
                ) {
                  var o = 9 * i * 4;
              ...
              (this.indexBuffer = eh(n, t, "vec4", r.aIndex)),
              (this.vertTypeBuffer = eh(n, t, "int", r.aVertType)),
              (this.atlasIdBuffer = eh(n, t, "int", r.aAtlasId)),
              (this.texBuffer = eh(n, t, "vec4", r.aTex)),
              (this.pointAPointBBuffer = eh(n, t, "vec4", r.aPointAPointB)),
              (this.pointCPointDBuffer = eh(n, t, "vec4", r.aPointCPointD)),
              (this.lineWidthBuffer = eh(n, t, "vec2", r.aLineWidth)),
              (this.colorBuffer = eh(n, t, "vec4", r.aColor)),
              (this.cornerRadiusBuffer = eh(n, t, "vec4", r.aCornerRadius)),
              (this.borderColorBuffer = eh(n, t, "vec4", r.aBorderColor)),
        ...
        },
        {
          key: "drawTexture",
          value: function (e, t, n) {
            var a = this.atlasManager,
              o = this.batchManager,
              s = a.getRenderTypeOpts(n);
            if (
              this._isVisible(e, s) &&
              ...
              if (this.renderTarget.picking && s.getTexPickingMode) {
                ...
                if (l === hh) return;
                if (l == fh) return void this.drawPickingRectangle(e, t, n);
              }
              var u,
                c = r(a.getAtlasInfo(e, n));
              try {
                for (c.s(); !(u = c.n()).done;) {
                  var d = u.value,
                    h = d.atlas,
                    f = d.tex1,
                    p = d.tex2;
                  o.canAddToCurrentBatch(h) || this.endBatch();
                  for (
                    var g = o.getAtlasIndexForBatch(h),
                      v = 0,
                      y = [
                        [f, !0],
                        [p, !1],
        ...
        },
        {
          ...
          value: function (e, t, n) {
            ...
            ((this.vertTypeBuffer.getView(a)[0] = 4),
              Gd(t, this.indexBuffer.getView(a)),
              Kd([0, 0, 0], 1, this.colorBuffer.getView(a)));
        ...
        },
        {
          ...
          value: function (e, t, n) {
            ...
            if (this._isVisible(e, r)) {
              ...
              if (
                void 0 === i ||
                (r.isSimple && !r.isSimple(e, this.renderTarget))
              )
                this.drawTexture(e, t, n);
              else {
                var o = this.instanceCount;
                if (
                  ((this.vertTypeBuffer.getView(o)[0] = i), 5 === i || 6 === i)
                ) {
                ...
                Gd(t, this.indexBuffer.getView(o));
                var c = this.renderTarget.picking
                    ? 1
                    : "node-body" === n
                      ? e.effectiveOpacity()
                      : 1,
                  d = this.renderTarget.picking
                    ? 1
                    : e.pstyle(a.opacity).value * c;
                Kd(e.pstyle(a.color).value, d, this.colorBuffer.getView(o));
        ...
        },
        {
          ...
          value: function (e, t, n) {
            var r = n.w,
              a = n.h;
            if ("auto" === e.pstyle(t).value) return Dn(r, a);
              ...
              if (
                ...
                if ("none" !== e.pstyle(n + "-arrow-shape").value) {
                  ...
                  (rh(f),
                    ...
                    Gd(t, this.indexBuffer.getView(h)),
                    Kd(s, l, this.colorBuffer.getView(h)),
                    this.instanceCount++,
                    this.instanceCount >= this.maxInstances && this.endBatch());
                }
            }
              ...
              if (n) {
                ...
                if (
                  ...
                  ((this.vertTypeBuffer.getView(l)[0] = 1),
                    Gd(t, this.indexBuffer.getView(l)),
                    Kd(o, s, this.colorBuffer.getView(l)),
                  ...
                  for (var c = 0; c < n.length - 2; c += 2) {
                    ...
                    ((this.vertTypeBuffer.getView(d)[0] = 2),
                      Gd(t, this.indexBuffer.getView(d)),
                      Kd(o, s, this.colorBuffer.getView(d)),
                    ...
                    var h = n[c - 2],
                      ...
                      b = n[c + 5];
                    (0 == c &&
                      ((h = 2 * p - v + 0.001), (f = 2 * g - y + 0.001)),
                      c == n.length - 4 &&
                        ((m = 2 * v - p + 0.001), (b = 2 * y - g + 0.001)));
                    var x = this.pointAPointBBuffer.getView(d);
                    ((x[0] = h), (x[1] = f), (x[2] = p), (x[3] = g));
        ...
        },
        {
          ...
          value: function () {
            ...
            if (0 !== a) {
              ...
              var f = Kd(this.bgColor, 1);
              (e.uniform4fv(i.uBGColor, f),
                e.drawArraysInstanced(e.TRIANGLES, 0, n, a),
                e.bindVertexArray(null),
                e.bindTexture(e.TEXTURE_2D, null),
                this.debug &&
                  this.batchDebugInfo.push({ count: a, atlasCount: c.length }),
                this.startBatch());
            }
          },
        },
...
function vh(e, t) {
  var n = e._private.rscratch;
  return dt(n, "labelWrapCachedLines", t) || [];
}
gh.initWebgl = function (e, t) {
  var n = this,
    a = n.data.contexts[n.WEBGL];
  ...
  var o = function (e) {
    ...
    u = function (e) {
      return "yes" === e.pstyle("text-events").strValue ? fh : hh;
    },
    c = function (e) {
      var t = e.position(),
        n = t.x,
  ...
  (n.drawing.addAtlasCollection("node", { texRows: e.webglTexRowsNodes }),
    ...
    n.drawing.addTextureAtlasRenderType("label", {
      ...
      getBoundingBox: mh(t.getLabelBox, null),
      drawClipped: !0,
    ...
    n.drawing.addTextureAtlasRenderType("edge-source-label", {
      ...
      getBoundingBox: mh(t.getSourceLabelBox, "source"),
      drawClipped: !0,
    ...
    n.drawing.addTextureAtlasRenderType("edge-target-label", {
      ...
      getBoundingBox: mh(t.getTargetLabelBox, "target"),
      drawClipped: !0,
  ...
  (n.onUpdateEleCalcs(function (e, t) {
    ...
    (function (e) {
      ...
      ((e.matchCanvasSize = function (t) {
        ...
        (e.findNearestElements = function (t, n, a, o) {
          return (function (e, t, n) {
            var a,
              o,
              s,
      ...
      e.invalidateCachedZSortedEles = function () {
        (a.call(e), (e.pickingFrameBuffer.needsDraw = !0));
      };
      var o = e.notify;
...
function wh(e, t, n) {
  var a;
  e.webglDebug && (a = performance.now());
  var i = e.drawing,
    o = 0;
  if (
    (n.screen &&
    ...
    var l = (function (e) {
      ...
      u = e.getCachedZSortedEles();
    if (((o = u.length), i.startFrame(l, n), n.screen)) {
      for (var c = 0; c < u.nondrag.length; c++) xh(e, c, u.nondrag[c]);
      for (var d = 0; d < u.drag.length; d++) xh(e, d, u.drag[d]);
    } else if (n.picking) for (var h = 0; h < u.length; h++) xh(e, h, u[h]);
    (i.endFrame(),
      n.screen &&
  ...
  if (e.webglDebug) {
    var f = performance.now(),
      ...
      v = [
        ...
        "".concat(g.simpleCount, " simple shapes"),
      ].join(", ");
    (console.log("WebGL (".concat(n.name, ") - frame time ").concat(p, "ms")),
      console.log("Totals:"),
...
for (
  var Eh = {
      ...
      drawRoundRectanglePath: function (e, t, n, r, a, i) {
        var o = r / 2,
          s = a / 2,
          l = "auto" === i ? Dn(r, a) : Math.min(i, s, o);
        (e.beginPath && e.beginPath(),
          e.moveTo(t, n - s),
  ...
  ((Ch[Bh] = Math.sin(Bh)), (Ph[Bh] = Math.cos(Bh)));
Eh.drawEllipsePath = function (e, t, n, r, a) {
  if ((e.beginPath && e.beginPath(), e.ellipse))
    ...
    for (
      ...
      ((i = t - s * Ch[u] * kh + s * Ph[u] * Th),
        (o = n + l * Ph[u] * kh + l * Ch[u] * Th),
...
((Dh.createBuffer = function (e, t) {
  ...
  (Dh.bufferCanvasImage = function (e) {
    ...
    if (void 0 !== e.scale) ((a *= e.scale), (i *= e.scale), (l = e.scale));
      ...
      var u = 1 / 0,
        c = 1 / 0;
      (G(e.maxWidth) && (u = (l * e.maxWidth) / a),
        G(e.maxHeight) && (c = (l * e.maxHeight) / i),
        (a *= l = Math.min(u, c)),
        (i *= l));
    }
    o || ((a *= s), (i *= s), (l *= s));
  ...
  (Dh.png = function (e) {
    return Ah(e, this.bufferCanvasImage(e), "image/png");
  }),
  (Dh.jpg = function (e) {
    return Ah(e, this.bufferCanvasImage(e), "image/jpeg");
  }));
var Mh = {
...
function Nh(e) {
  ...
  (e.webgl &&
    ((Ih.CANVAS_LAYERS = t.CANVAS_LAYERS = 4),
    console.log("webgl rendering enabled")),
    (t.data = {
      canvases: new Array(Ih.CANVAS_LAYERS),
      contexts: new Array(Ih.CANVAS_LAYERS),
      canvasNeedsRedraw: new Array(Ih.CANVAS_LAYERS),
      bufferCanvases: new Array(Ih.BUFFER_COUNT),
      bufferContexts: new Array(Ih.CANVAS_LAYERS),
    }));
  ...
  d &&
    d.userAgent.match(/msie|trident|edge/i) &&
    ((s["-ms-touch-action"] = "none"), (s["touch-action"] = "none"));
  for (var l = 0; l < Ih.CANVAS_LAYERS; l++) {
    var u = (t.data.canvases[l] = n.createElement("canvas")),
      c = Ih.CANVAS_TYPES[l];
    ((t.data.contexts[l] = u.getContext(c)),
      t.data.contexts[l] || tt("Could not create canvas of type " + c),
      Object.keys(s).forEach(function (e) {
        u.style[e] = s[e];
      }),
      (u.style.position = "absolute"),
      u.setAttribute("data-id", "layer" + l),
      (u.style.zIndex = String(Ih.CANVAS_LAYERS - l)),
      t.data.canvasContainer.appendChild(u),
      (t.data.canvasNeedsRedraw[l] = !1));
  }
  ((t.data.topCanvas = t.data.canvases[0]),
    t.data.canvases[Ih.NODE].setAttribute(
      "data-id",
      "layer" + Ih.NODE + "-node",
    ),
    t.data.canvases[Ih.SELECT_BOX].setAttribute(
      "data-id",
      "layer" + Ih.SELECT_BOX + "-selectbox",
    ),
    t.data.canvases[Ih.DRAG].setAttribute(
      "data-id",
      "layer" + Ih.DRAG + "-drag",
    ),
    t.data.canvases[Ih.WEBGL] &&
      t.data.canvases[Ih.WEBGL].setAttribute(
        "data-id",
        "layer" + Ih.WEBGL + "-webgl",
      ));
  for (l = 0; l < Ih.BUFFER_COUNT; l++)
  ...
  var h = Qt(),
    ...
    L = function (e) {
      var t = k(e),
        n = f(k(e));
      if (e.isNode()) {
        switch (Ts(e.pstyle("text-halign").value)) {
          case "left":
            n.x = -t.w - (t.leftPad || 0);
            break;
          case "right":
        ...
        switch (Cs(e.pstyle("text-valign").value)) {
          case "top":
            n.y = -t.h - (t.topPad || 0);
            break;
          case "bottom":
...
((Ih.CANVAS_LAYERS = 3),
  ...
  (Ih.NODE = 2),
  (Ih.WEBGL = 3),
  (Ih.CANVAS_TYPES = ["2d", "2d", "2d", "webgl2"]),
  (Ih.BUFFER_COUNT = 3),
  (Ih.TEXTURE_BUFFER = 0),
  (Ih.MOTIONBLUR_BUFFER_NODE = 1),
  (Ih.MOTIONBLUR_BUFFER_DRAG = 2),
  (Ih.redrawHint = function (e, t) {
    var n = this;
    switch (e) {
      case "eles":
        n.data.canvasNeedsRedraw[Ih.NODE] = t;
        break;
      case "drag":
        n.data.canvasNeedsRedraw[Ih.DRAG] = t;
        break;
      case "select":
        n.data.canvasNeedsRedraw[Ih.SELECT_BOX] = t;
        break;
      case "gc":
        n.data.gc = !0;
    }
  }));
var Lh = "undefined" != typeof Path2D;
((Ih.path2dEnabled = function (e) {
  if (void 0 === e) return this.pathsEnabled;
  this.pathsEnabled = !!e;
}),
  (Ih.usePaths = function () {
    return Lh && this.pathsEnabled;
  }),
  (Ih.setImgSmoothing = function (e, t) {
  ...
  (Ih.makeOffscreenCanvas = function (e, t) {
    var n;
    "undefined" !==
    ("undefined" == typeof OffscreenCanvas ? "undefined" : l(OffscreenCanvas))
      ? (n = new OffscreenCanvas(e, t))
      : (((n = this.cy.window().document.createElement("canvas")).width = e),
        (n.height = t));
    return n;
  }),
  [wd, Sd, Id, Ld, zd, Vd, jd, gh, Eh, Dh, Mh].forEach(function (e) {
    ve(Ih, e);
  }));
var zh = [
    { type: "layout", extensions: uc },
    {
      type: "renderer",
      extensions: [
        { name: "null", impl: cc },
...
function Fh(e, t, n) {
  ...
  if ("core" === e) {
    if (Eu.prototype[t]) return a(t);
    Eu.prototype[t] = n;
  } else if ("collection" === e) {
    if (Ol.prototype[t]) return a(t);
    Ol.prototype[t] = n;
  } else if ("layout" === e) {
    for (
      var i = function (e) {
    ...
    (ve(o, {
      createEmitter: function () {
        return ((this._private.emitter = new nl(h, this)), this);
      },
      emitter: function () {
        return this._private.emitter;
      },
  ...
  return be({ map: Oh, keys: [e, t], value: r });
}
function Xh(e, t) {
  return xe({ map: Oh, keys: [e, t] });
}
function jh(e, t, n, r, a) {
  return be({ map: Vh, keys: [e, t, n, r], value: a });
}
function Yh(e, t, n, r) {
  return xe({ map: Vh, keys: [e, t, n, r] });
}
var qh = function () {
    ...
    : 3 === arguments.length
      ...
      : 4 === arguments.length
        ...
        : 5 === arguments.length
          ...
          : void tt("Invalid extension access syntax");
};
((Eu.prototype.extension = qh),
...
var Wh = function () {
    if (!(this instanceof Wh)) return new Wh();
    this.length = 0;
  },
  Uh = Wh.prototype;
    ...
    if (W(e)) this[n].properties.push({ name: e, value: t });
      ...
      for (var r = e, a = Object.keys(r), i = 0; i < a.length; i++) {
        var o = a[i],
          s = r[o];
        if (null != s) {
          var l = yu.properties[o] || yu.properties[oe(o)];
          if (null != l) {
            var u = l.name,
              c = s;
...
var Hh = function (e) {
  return (
    void 0 === e && (e = {}),
    K(e) ? new Eu(e) : W(e) ? qh.apply(qh, arguments) : void 0
  );
};
((Hh.use = function (e) {
  var t = Array.prototype.slice.call(arguments, 1);
  return (t.unshift(Hh), e.apply(null, t), this);
}),
  (Hh.warnings = function (e) {
    return nt(e);
  }),
  (Hh.version = "3.34.0"),
  (Hh.stylesheet = Hh.Stylesheet = Wh));

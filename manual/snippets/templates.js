// Yume v0.11.1 authoring templates.
...
const itemDefinition = {
  ...
  usable: true,
  effects: [{ type: "playSound", soundId: "item-use" }],
};

const contextualItemUseTrigger = {
  id: "example-item-use",
  region: { col: 0, row: 0, width: 10, height: 8 },
  events: ["itemUse"],
  itemId: "example-item",
  frequency: "always",
  effects: [{ type: "showText", pages: ["The item reacts to this place."] }],
};
...
const cameraSequence = [
  { type: "cameraPan", offsetX: -64, offsetY: 0, durationMs: 500 },
  {
    ...
    afterClose: [
      ...
      {
        type: "showText",
        pages: ["The zoom has finished."],
        afterClose: [{ type: "cameraReset", durationMs: 500 }],
      },
    ],
  },
];

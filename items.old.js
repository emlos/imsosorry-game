export const ITEMS = {
  "pink-orb": {
    ...
    description:
      "A warm pink sphere. Its surface seems deeper than its size allows.",
    usable: true,
    effects: [
  ...
  "room05-possession-collectible": {
    ...
    icon: "./assets/items/pink-orb.png",
    description:
      "A test collectible whose current inventory ownership is authoritative.",
    usable: false,
  },
  ...
  "animation-test-token": {
    ...
    description:
      "A bright token used to keep the animation-test inventory available.",
    usable: false,
  },
};
